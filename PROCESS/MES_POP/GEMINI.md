...
## ⚡ CLI HUB: `.\mes.ps1`
- `shell` — Bật Persistent REPL Shell tức thời (<0.05s response)
...
- `watchdog-hidden` / `watchdog-status` — Auto-Pilot tuần tra 24/7
- `dashboard` — Realtime Factory Web Dashboard
