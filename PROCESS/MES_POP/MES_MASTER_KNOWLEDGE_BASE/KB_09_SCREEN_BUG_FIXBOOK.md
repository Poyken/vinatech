...
Related Files:
  ...
  - [HOTFIX_LOG.md](file:///c:/Users/User%20Vinatech.DESKTOP-RJJSEQU/Desktop/PROCESS/MES_POP/AI_AGENT_CONFIG/HOTFIX_LOG.md)
-->
...
> ← [Về INDEX](file:///c:/Users/User%20Vinatech.DESKTOP-RJJSEQU/Desktop/PROCESS/MES_POP/MES_MASTER_KNOWLEDGE_BASE/KB_INDEX.md)
...
> 🔗 Chi tiết: [KB_06 §9.4](file:///c:/Users/User%20Vinatech.DESKTOP-RJJSEQU/Desktop/PROCESS/MES_POP/MES_MASTER_KNOWLEDGE_BASE/KB_06_MASTER_DATA_TOOLS.md)
...
> 🔗 Chi tiết: [KB_06 §9.5](file:///c:/Users/User%20Vinatech.DESKTOP-RJJSEQU/Desktop/PROCESS/MES_POP/MES_MASTER_KNOWLEDGE_BASE/KB_06_MASTER_DATA_TOOLS.md)
...
> 🔗 Chi tiết: [KB_06 §9.6](file:///c:/Users/User%20Vinatech.DESKTOP-RJJSEQU/Desktop/PROCESS/MES_POP/MES_MASTER_KNOWLEDGE_BASE/KB_06_MASTER_DATA_TOOLS.md)
...
> 🔗 Chi tiết: [KB_04 §6.20](file:///c:/Users/User%20Vinatech.DESKTOP-RJJSEQU/Desktop/PROCESS/MES_POP/MES_MASTER_KNOWLEDGE_BASE/KB_04/KB_04_01_CORE_PACKAGING.md), [KB_05 §8.7](file:///c:/Users/User%20Vinatech.DESKTOP-RJJSEQU/Desktop/PROCESS/MES_POP/MES_MASTER_KNOWLEDGE_BASE/KB_05/KB_05_01_QC_AND_ELECTRODE_CORE.md)
...
> 🔗 Chi tiết: [KB_05 §8.7](file:///c:/Users/User%20Vinatech.DESKTOP-RJJSEQU/Desktop/PROCESS/MES_POP/MES_MASTER_KNOWLEDGE_BASE/KB_05/KB_05_01_QC_AND_ELECTRODE_CORE.md)
...
| 3 | Gộp box HN523 lỗi Qty=0 | `STB_PackingStandard` thiếu record cho model Hà Nam | INSERT record vào `STB_PackingStandard` — xem [KB_04 §6.13](file:///c:/Users/User%20Vinatech.DESKTOP-RJJSEQU/Desktop/PROCESS/MES_POP/MES_MASTER_KNOWLEDGE_BASE/KB_04/KB_04_01_CORE_PACKAGING.md) |
| 4 | Gộp box lỗi do PO có công đoạn hậu đóng gói B523 | Thiếu lịch sử Route `V-28_BG` | Chèn dòng ProdRouteHist giả lập — xem [KB_04 §6.13.2](file:///c:/Users/User%20Vinatech.DESKTOP-RJJSEQU/Desktop/PROCESS/MES_POP/MES_MASTER_KNOWLEDGE_BASE/KB_04/KB_04_01_CORE_PACKAGING.md) |
...
| 8 | Tem Box in từ POP Kiosk bị co ngắn mã vạch `PackingID` (Code 128 hẹp), máy quét không đọc được | POP Kiosk không gọi SP sinh mã `PackingID` chuẩn 11 ký tự (`PKQR1900142`) vào `STB_MaterialLotInfo.PackingID`. Khi in tem `포장라벨NewVietNam`, tham số `?PackingID` bị thiếu hoặc rút gọn ➔ DevExpress `AutoModule = true` co rúm các nét vạch lại cực ngắn, kèm đầu in nhiệt bị mờ kép (ghosting) làm dính nét | **Khắc phục ngay dưới xưởng:** Mở MES WinForm **B523** hoặc **B528**, quét mã Lot cha, chọn Box con tương ứng rồi bấm **In lại tem** ➔ Tem in từ WinForm mang đủ mã `PK...` 11 ký tự, vạch trải đều toàn khung và quét ăn ngay 100%. Vệ sinh đầu in nhiệt máy in bằng cồn. |

> 🔗 Chi tiết: [KB_04 §6](file:///c:/Users/User%20Vinatech.DESKTOP-RJJSEQU/Desktop/PROCESS/MES_POP/MES_MASTER_KNOWLEDGE_BASE/KB_04/KB_04_01_CORE_PACKAGING.md), [KB_08 §5](file:///c:/Users/User%20Vinatech.DESKTOP-RJJSEQU/Desktop/PROCESS/MES_POP/MES_MASTER_KNOWLEDGE_BASE/KB_08_CORE_SP_ENGINE.md)
...
| 11 | B530 popup chặn "Search failed: Vui lòng sử dụng hệ thống POP để nhập sản lượng" & Kiosk báo "This route is already completed in MES" | Chuyền sản xuất (VD: `VVHYC-01` HY Cell Line #1) đã chuyển quyền chốt sản lượng sang Kiosk. Nếu POP Kiosk chặn báo đã hoàn thành trong MES là do trong `STB_ProdRouteHist` đã tồn tại bản ghi công đoạn cũ từ các ca trước | 1. Không chốt trên WinForm, bắt buộc chốt qua Web Kiosk.<br>2. Xóa bản ghi kẹt cũ trong MES: `DELETE FROM STB_ProdRouteWorkerHist WHERE ProdRouteHistNo = 'mã'` + `DELETE FROM STB_ProdRouteHist WHERE ProdRouteHistNo = 'mã' AND RouteCode = 'mã_route'` (xem [POP_KB_03 § 2.6](file:///c:/Users/User%20Vinatech.DESKTOP-RJJSEQU/Desktop/PROCESS/MES_POP/POP_KNOWLEDGE_BASE/POP_KB_03_TROUBLESHOOTING.md#26-pop-err-09-lỗi-this-route-is-already-completed-in-mes-khi-chốt-công-đoạn)).<br>3. F5 Kiosk bấm "Hoàn thành sản xuất" lại. |
| 12 | Không đồng nhất công đoạn giữa Kiosk POP và MES WinForm (Lệch trạm view / Nhảy cóc công đoạn hoặc kẹt chốt sớm) | 1. Chốt chéo: WinForm đã chốt trước làm Kiosk chặn đè.<br>2. Nhảy cóc: Bỏ qua công đoạn trung gian V-27_HY sang V-28_HY Đóng gói.<br>3. Chốt sớm V-28_HY làm Kiosk báo Còn lại: 0 EA. | Tra cứu bằng `.\mes.ps1 trace '<Lot>'`. Nếu kẹt công đoạn giữa: chạy Template 3 POP_KB_03 (xóa `ProdRouteWorkerHist` + `ProdRouteHist` kẹt). Nếu chốt sớm Đóng gói: chạy Template 4 POP_KB_03 (xóa `STB_MaterialLotInfo` BTP + `STB_ProdRouteHist` V-28_HY + `VINATECH_POP.dbo.VINA_PACKING_REMAIN_QTY`) — xem [HOTFIX_LOG § ID_48, ID_49](file:///c:/Users/User%20Vinatech.DESKTOP-RJJSEQU/Desktop/PROCESS/MES_POP/AI_AGENT_CONFIG/HOTFIX_LOG.md). |

> 🔗 Chi tiết: [KB_03 §B530](file:///c:/Users/User%20Vinatech.DESKTOP-RJJSEQU/Desktop/PROCESS/MES_POP/MES_MASTER_KNOWLEDGE_BASE/KB_03/KB_03_02_CELL_LINE.md), [KB_08 §2](file:///c:/Users/User%20Vinatech.DESKTOP-RJJSEQU/Desktop/PROCESS/MES_POP/MES_MASTER_KNOWLEDGE_BASE/KB_08_CORE_SP_ENGINE.md), [POP_KB_03 § 2.6, § 2.7](file:///c:/Users/User%20Vinatech.DESKTOP-RJJSEQU/Desktop/PROCESS/MES_POP/POP_KNOWLEDGE_BASE/POP_KB_03_TROUBLESHOOTING.md)
...
> 🔗 Chi tiết: [KB_05_01 §8.10](file:///c:/Users/User%20Vinatech.DESKTOP-RJJSEQU/Desktop/PROCESS/MES_POP/MES_MASTER_KNOWLEDGE_BASE/KB_05/KB_05_01_QC_AND_ELECTRODE_CORE.md#810-quy-trình-dọn-dẹp--xóa-mẻ-trộn-điện-cực-thừa-electrode-mixing-cancellation-sop), [KB_05_02 §7.6](file:///c:/Users/User%20Vinatech.DESKTOP-RJJSEQU/Desktop/PROCESS/MES_POP/MES_MASTER_KNOWLEDGE_BASE/KB_05/KB_05_02_SCREEN_BUGS_QC.md)
...
| 4 | Vỏ nhôm (AluCase) mới báo sai chủng loại | Mã vỏ nhôm bị **hardcode** trong SP `usp_Vietnam_RawMaterialInputHist_uid` | ALTER SP bổ sung mã mới vào `IF / NOT IN` — xem [KB_05_02 §7.4](file:///c:/Users/User%20Vinatech.DESKTOP-RJJSEQU/Desktop/PROCESS/MES_POP/MES_MASTER_KNOWLEDGE_BASE/KB_05/KB_05_02_SCREEN_BUGS_QC.md) |
...
| 9 | **POP Kiosk báo "Hết hàng" (0 KG) cho dung dịch điện phân** (GBEC00-008 / GBCP00-004) — thùng 150 KG mới đưa lên máy chỉ quét 1 lần đã về 0 | **Xung đột chuyển vùng kho VN ➔ HY:** Thùng xuất từ kho Hà Nam (`ROUTE_VN_WH`), khi quét tại chuyền Hưng Yên, hệ thống tự sinh bản ghi mới ở `ROUTE_HY_WH` và set bản ghi cũ VN về 0. Hoặc **Auto-exhaust:** quét Lot dung dịch mới tự đóng thùng cũ về 0. | Phục hồi **100% InitialQty (150 KG)** tại `ROUTE_HY_WH`: `UPDATE STB_MaterialLotInfo SET CurrentQty=150.0 WHERE LotID='mã' AND MaterialWarehouseCode='ROUTE_HY_WH'`. Sau đó reload NVL BOM trên Kiosk POP. Chi tiết: [POP_KB_03 §2.14 & Template 6](file:///c:/Users/User%20Vinatech.DESKTOP-RJJSEQU/Desktop/PROCESS/MES_POP/POP_KNOWLEDGE_BASE/POP_KB_03_TROUBLESHOOTING.md). ⚠️ Thùng 150 KG chạy 2 ngày mới hết, phải phục hồi đủ 100% — KHÔNG phục hồi số lẻ. |

> 🔗 Chi tiết: [KB_05_02 §7](file:///c:/Users/User%20Vinatech.DESKTOP-RJJSEQU/Desktop/PROCESS/MES_POP/MES_MASTER_KNOWLEDGE_BASE/KB_05/KB_05_02_SCREEN_BUGS_QC.md), [KB_03 §B597](file:///c:/Users/User%20Vinatech.DESKTOP-RJJSEQU/Desktop/PROCESS/MES_POP/MES_MASTER_KNOWLEDGE_BASE/KB_03/KB_03_02_CELL_LINE.md), [POP_KB_03 §2.14](file:///c:/Users/User%20Vinatech.DESKTOP-RJJSEQU/Desktop/PROCESS/MES_POP/POP_KNOWLEDGE_BASE/POP_KB_03_TROUBLESHOOTING.md)
...
| 2 | B791 NG Defect Repair — SL NG lệch | `DefectQty` trong `STB_ProdRouteHist` không khớp `STB_DefectRepairInfo` | Đồng bộ lại: xem [KB_03 §5.8](file:///c:/Users/User%20Vinatech.DESKTOP-RJJSEQU/Desktop/PROCESS/MES_POP/MES_MASTER_KNOWLEDGE_BASE/KB_03/KB_03_02_CELL_LINE.md) |
...
> 🔗 Chi tiết: [KB_04 §6.9.4](file:///c:/Users/User%20Vinatech.DESKTOP-RJJSEQU/Desktop/PROCESS/MES_POP/MES_MASTER_KNOWLEDGE_BASE/KB_04/KB_04_01_CORE_PACKAGING.md)
...
| 4 | Chuyển "Ngày làm" hàng loạt cho các Lot dập ca đêm/rạng sáng (00:00 - 08:30 AM) sang ngày làm việc mới (Hotfix ID_52, ID_53, ID_54) | Nếu chỉ `UPDATE JobDate = 'YYYY-MM-DD'` mà không điều chỉnh giờ, do `ProdDateTime < 10:00:00 AM`, SP `usp_LotTrackingInfo_VVT2_get` vẫn gom toàn bộ các Lot này về ngày làm việc hôm trước! | **Giải pháp chuẩn hóa:**<br>Dùng kỹ thuật cộng thời gian: `SET ProdDateTime = DATEADD(HOUR, 10, ProdDateTime), JobDate = 'YYYY-MM-DD'` cho các Lot tại công đoạn đích (ví dụ `V-24_HY`).<br>👉 Đẩy giờ thực tế từ `00:32 - 08:22` sang `10:32 - 18:22` (vượt ngưỡng cắt ca 10:00:00 AM của B782), vừa giữ nguyên khoảng cách thời gian giữa các Lot vừa hiển thị 100% trên B782 ngày mới và dọn sạch ngày cũ. |
| 5 | Không link được số lượng NG từ POP Kiosk xuống NAIS B782 (từ Winding đến Ngoại quan, ví dụ Model 35105 / Lot `VVQR193R072769`). Cột `DefectQty` và các cột phân loại lỗi (`SX_NG`, `PQC`, `Ktra_ThuongxuyenSX`, `Ktra_CoDinhSX`, `SuaMay`, `SetupMay`) hiển thị 0 hoặc rỗng | POP Kiosk khi lưu lỗi phế vào bảng `STB_DefectRepairInfo` chỉ ghi nhận `DefectQty` và để cột `RepairQty = NULL`. Trong SP `usp_LotTrackingInfo_VVT2_get`, 12 vị trí tính cột NG phân loại dùng `a.DefectQty - a.RepairQty` mà thiếu `ISNULL(..., 0)`. Vì trong SQL Server `số - NULL = NULL`, dẫn đến toàn bộ biểu thức cộng tổng phế bị NULL/0 trên NAIS B782 | **Hotfix SP `usp_LotTrackingInfo_VVT2_get` (Chuẩn hóa 2026-09-20 - vanduc):**<br>Bọc `sum(ISNULL(a.DefectQty, 0)) - sum(ISNULL(a.RepairQty, 0))` ở cả 12 vị trí trong 2 nhánh:<br>1. Nhánh 1 (Dòng 76–83 cho từng xưởng): Sửa 6 cột `PQC`, `SX_NG`, `SuaMay`, `Ktra_ThuongxuyenSX`, `Ktra_CoDinhSX`, `SetupMay`.<br>2. Nhánh 2 (Dòng 400–407 cho `tonghainhamay`): Sửa 6 cột tương tự.<br>*(Lưu ý dài hạn: Cần bổ sung default 0 hoặc job chuẩn hóa `RepairQty = 0 WHERE RepairQty IS NULL` trong `STB_DefectRepairInfo` vì toàn DB có hơn 140 SP dùng phép trừ này).* |
...
> 🔗 Chi tiết: [KB_05 §9.1](file:///c:/Users/User%20Vinatech.DESKTOP-RJJSEQU/Desktop/PROCESS/MES_POP/MES_MASTER_KNOWLEDGE_BASE/KB_05/KB_05_01_QC_AND_ELECTRODE_CORE.md)
...
> 🔗 Chi tiết: [KB_05 §9.5](file:///c:/Users/User%20Vinatech.DESKTOP-RJJSEQU/Desktop/PROCESS/MES_POP/MES_MASTER_KNOWLEDGE_BASE/KB_05/KB_05_01_QC_AND_ELECTRODE_CORE.md)
...
> 🔗 Chi tiết: [KB_05_02_SCREEN_BUGS_QC.md](file:///c:/Users/User%20Vinatech.DESKTOP-RJJSEQU/Desktop/PROCESS/MES_POP/MES_MASTER_KNOWLEDGE_BASE/KB_05/KB_05_02_SCREEN_BUGS_QC.md#L752) (§ Kịch bản B: Hủy kết quả QC)
...
| # | Triệu chứng | Nguyên nhân | Fix |
|---|---|---|---|
| 1 | Cột Note1 thừa trên Grid / cột bị xáo | Lỗi metadata grid trong SmartFramework | Rebuild bảng + ALTER bảng tương ứng — xem [KB_05_02 §7.8](file:///c:/Users/User%20Vinatech.DESKTOP-RJJSEQU/Desktop/PROCESS/MES_POP/MES_MASTER_KNOWLEDGE_BASE/KB_05/KB_05_02_SCREEN_BUGS_QC.md) |
...
| # | Triệu chứng | Nguyên nhân | Fix |
|---|---|---|---|
| 1 | OCV chỉ hiện 20 dòng thay vì 50 | SP `usp_Vietnam_MaterialFOQcDetail_get` thiếu block WHILE cho DetailNo=2 (OCV) | Thêm block WHILE cho OCV — xem [KB_05_02 §9.6](file:///c:/Users/User%20Vinatech.DESKTOP-RJJSEQU/Desktop/PROCESS/MES_POP/MES_MASTER_KNOWLEDGE_BASE/KB_05/KB_05_02_SCREEN_BUGS_QC.md) |
...
| # | Triệu chứng | Nguyên nhân | Fix |
|---|---|---|---|
| 1 | CustomerPartNo trống khi in tem | `STB_CustomerPartNoInfo` thiếu mapping model→customer | INSERT mapping: xem [KB_07 §5.4](file:///c:/Users/User%20Vinatech.DESKTOP-RJJSEQU/Desktop/PROCESS/MES_POP/MES_MASTER_KNOWLEDGE_BASE/KB_07/KB_07_01_OVERVIEW.md) |
...
> 🔗 Chi tiết: [KB_07 §5](file:///c:/Users/User%20Vinatech.DESKTOP-RJJSEQU/Desktop/PROCESS/MES_POP/MES_MASTER_KNOWLEDGE_BASE/KB_07/KB_07_01_OVERVIEW.md)
...
| 3 | Đổi mã vật tư tự động lỗi | `STB_ChangeMaterialCode_HN` thiếu mapping | INSERT mapping mã cũ→mới — xem [KB_02 §3.1](file:///c:/Users/User%20Vinatech.DESKTOP-RJJSEQU/Desktop/PROCESS/MES_POP/MES_MASTER_KNOWLEDGE_BASE/KB_02/KB_02_01_WMS_CORE.md) |
| 4 | Quét/nhập mã Lot Vendor họ vỏ nhôm AOXING `GBAXAC-%` hoặc họ `GBNKSP-%` không tự động đọc được ngày sản xuất (trả về rỗng / 1900-01-01) ở F330/F620 | Hàm `fn_VVT_getdatebyVendorLot_MergeCode` và `fn_VVT_getdatebyVendorLot` bị hardcode mã đơn lẻ thay vì wildcard `LIKE 'GBAXAC-%'` (18 số) và `LIKE 'GBNKSP-%'` (Tháng mã hóa ký tự) | Cập nhật hàm `fn_VVT_getdatebyVendorLot_MergeCode` & `fn_VVT_getdatebyVendorLot` bổ sung wildcard parse tự động — xem chi tiết [KB_02_01 §4.11 Mẫu 5, Mẫu 6](file:///c:/Users/User%20Vinatech.DESKTOP-RJJSEQU/Desktop/PROCESS/MES_POP/MES_MASTER_KNOWLEDGE_BASE/KB_02/KB_02_01_WMS_CORE.md#3-các-mẫu-viết-logic-parse-ngày-thông-dụng) |

> 🔗 Chi tiết: [KB_02 §4.15](file:///c:/Users/User%20Vinatech.DESKTOP-RJJSEQU/Desktop/PROCESS/MES_POP/MES_MASTER_KNOWLEDGE_BASE/KB_02/KB_02_01_WMS_CORE.md)
...
| 4 | Khi xuất chuyển kho từ Hưng Yên (`VVT_F5`) về Bắc Ninh (`VVT_F1`), ô **Mã chuyền** bị trống hoặc hiện nhầm `HY_BN - Xuất NVL sang Hưng Yên` | 1. `STB_LineInfo` chưa có mã chuyền `BN_HY` thuộc xưởng `VVT_F5` trỏ về `ROH_VN_WH`.<br>2. Nhầm lẫn đảo ngược `WorkCenterCode` giữa `HY_BN` (Bắc Ninh) và `BN_HY` (Hưng Yên). | Vào **[B210]**: Cấu hình `BN_HY` (`WorkCenterCode = 'VVT_F5'`, `LineDesc = N'Xuất NVL sang Bắc Ninh'`, `MaterialWarehouseCode = 'ROH_VN_WH'`, `IsUsed = 1`). Giữ `HY_BN` ở `VVT_F1`. Khi hàng về tới Bắc Ninh, thủ kho bấm **"Xác nhận cấp NVL"** trên F430 để nhập kho. (vanduc 2026-09-07) |
...
| 2 | Danh sách mã Lot kho Hưng Yên (`ROH_HY_WH`) bị hiển thị lặp lại 2 lần trên lưới F721 / HY721 | SP `usp_vvt_MaterialLotInfo_get` dùng `UNION ALL` giữa 2 nguồn: Nguồn 1 (`STB_MaterialDocLotInfo` - hàng nhập theo chứng từ GR) và Nguồn 2 (`STB_MaterialLotInfo` - hàng tồn thực tế). Đối với kho Hưng Yên: (1) Các Lot nhập khẩu trực tiếp tại HY tồn tại ở cả 2 bảng dẫn đến bị hiển thị lặp 2 lần; (2) Các Lot ban đầu nhập ở Bắc Ninh (`ROH_VN_WH_01`) sau đó chuyển kho về Hưng Yên (`ROH_HY_WH`) chỉ nằm ở Nguồn 2. Nếu chỉ loại trừ đơn giản mã kho thì sẽ làm mất hàng chuyển kho. | Sử dụng cơ chế khử trùng lặp `NOT EXISTS (SELECT 1 FROM STB_MaterialDocLotInfo d WHERE d.LotID = STB_MaterialLotInfo.LotID AND d.MaterialLocationCode LIKE @MaterialWarehouseCode+'%' AND d.CreateUserID <> '23091804')` ở Nguồn 2. Đảm bảo: (1) Hàng nhập trực tiếp hiển thị đúng 1 dòng (DocType `GR`), (2) Hàng chuyển kho từ BN sang HY vẫn hiển thị đầy đủ 1 dòng tại kho HY, (3) Các kho khác (Bắc Ninh, Bắc Giang, Hà Nam, BG2) hoàn toàn giữ nguyên logic gốc không bị ảnh hưởng. File: `sql_hotfixes/fix_f721_hung_yen_duplicate_lots.sql`. (vanduc 2026-08-29) |
...
| # | Triệu chứng | Nguyên nhân | Fix |
|---|---|---|---|
| 1 | Gộp box lỗi Qty=0 | `STB_PackingStandard` thiếu record cho model HN | INSERT record — xem [KB_04 §6.13](file:///c:/Users/User%20Vinatech.DESKTOP-RJJSEQU/Desktop/PROCESS/MES_POP/MES_MASTER_KNOWLEDGE_BASE/KB_04/KB_04_01_CORE_PACKAGING.md) |
...
> 🔗 Chi tiết: [KB_05_02_SCREEN_BUGS_QC.md](file:///c:/Users/User%20Vinatech.DESKTOP-RJJSEQU/Desktop/PROCESS/MES_POP/MES_MASTER_KNOWLEDGE_BASE/KB_05/KB_05_02_SCREEN_BUGS_QC.md#L820) (§ Kịch bản sự cố khẩn cấp 3: Lỗi nhập phế HNC321)
...
> 🔗 Chi tiết: [KB_06 §9.3](file:///c:/Users/User%20Vinatech.DESKTOP-RJJSEQU/Desktop/PROCESS/MES_POP/MES_MASTER_KNOWLEDGE_BASE/KB_06_MASTER_DATA_TOOLS.md)
...
| Triệu chứng | Nguyên nhân | Fix |
|---|---|---|
| Lot chưa hoàn thành V-22 nhưng vẫn vào lò sấy được | SP không check `IsRouteFinish` trước khi cho vào lò | Thêm validation check — xem [KB_07 §5.1](file:///c:/Users/User%20Vinatech.DESKTOP-RJJSEQU/Desktop/PROCESS/MES_POP/MES_MASTER_KNOWLEDGE_BASE/KB_07/KB_07_01_OVERVIEW.md) |

### Doping JIG Auto-End Mất Lịch Sử
| Triệu chứng | Nguyên nhân | Fix |
|---|---|---|
| JIG chạy 6h auto-end → lịch sử biến mất | SP `autoend` không INSERT vào `Stb_VVT_DopingJIG_History` | ALTER SP thêm INSERT — xem [KB_07 §5.2](file:///c:/Users/User%20Vinatech.DESKTOP-RJJSEQU/Desktop/PROCESS/MES_POP/MES_MASTER_KNOWLEDGE_BASE/KB_07/KB_07_01_OVERVIEW.md) |

### [POP Kiosk] — POP Thiếu Thiết Bị / Ẩn Máy Tại Modal "Xác Nhận Kết Thúc" (Winding/Curling/Sleeving)
| Triệu chứng | Nguyên nhân | Fix |
|---|---|---|
| Modal "Xác nhận Kết thúc?" trên Kiosk hiển thị thiếu máy (ví dụ đếm 23 máy thay vì 27 máy Winding, thiếu máy C#2-2, C#10-1...) dù `STB_ProductMachine` đã cấu hình đủ | Máy bị kẹt trạng thái `MAPPING_STATUS = 'ACTIVE'` trong `VINATECH_POP.dbo.VINA_EQUIPMENT_MAPPING` từ Kế hoạch sản xuất (`DAY_PLAN_NO`) cũ do OP không bấm "Hủy gán / Release" khi xong ca và POP thiếu Auto-Release | 1. **Kiểm tra máy bị kẹt:** <br>`SELECT MAPPING_ID, DAY_PLAN_NO, LINE_CODE, EQUIPMENT_ID, EQUIPMENT_NAME, MAPPING_STATUS FROM VINATECH_POP.dbo.VINA_EQUIPMENT_MAPPING WITH(NOLOCK) WHERE EQUIPMENT_ID IN (...) AND MAPPING_STATUS IN ('ACTIVE', 'AUTO_MAPPED')`<br>2. **Backup Snapshot pre-flight:** xuất JSON 7 bản ghi.<br>3. **Giải phóng máy (Hotfix):**<br>`UPDATE VINATECH_POP.dbo.VINA_EQUIPMENT_MAPPING SET MAPPING_STATUS = 'RELEASED', RELEASED_AT = GETDATE(), RELEASE_REASON = N'Release cho Model 35105', NO_EMP_MODIFYER = 'vanduc', CD_COMPANY_MODIFYER = 'VINA' WHERE MAPPING_ID IN (...) AND MAPPING_STATUS IN ('ACTIVE', 'AUTO_MAPPED')`<br>4. Yêu cầu OP tải lại trang hoặc mở lại popup để nhận đủ máy. |
