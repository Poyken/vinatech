...
## Tra Cứu Nhanh & 2 CLI Hubs
- **POP Kiosk Hub:** `.\pop.ps1` (L1 Cache: `AI_AGENT_CONFIG/POP_MATRIX.json`)
- **MES Core Hub:** `.\mes.ps1` (L1 Cache: `AI_AGENT_CONFIG/QUICK_MATRIX.json`, 95 screens)
- Chi tiết xem tại `GEMINI.md`.
