-- ============================================================================
-- Purpose: Fix F330 Exception error for 153_SATRAY2245 (conversion failed date/time)
-- Author: vanduc edit 20260724
-- Description:
--   1. Comment out '153_SATRAY2245' in fn_VVT_getdatebyVendorLot_MergeCode to prevent auto-parsing
--   2. Add '153_SATRAY2245' to manual LotAttr10 entry list in usp_DoChangeMaterialDocLotInfo
