-- =============================================
-- Hotfix ID: 18_FIX_MATERIAL_QC_INSPECTION_ITEM_HY_IUD_BUG
-- Target Object: usp_MaterialQcInspectionItem_HY_iud
-- Author: vanduc
-- Date: 2026-06-25
-- Description: Fix critical bug in usp_MaterialQcInspectionItem_HY_iud where it writes to STB_MaterialQcInspectionItem (shared table) instead of STB_MaterialQcInspectionItem_HY (HY private table)
-- =============================================
...
-- Description:	
-- =============================================
ALTER PROCEDURE [dbo].[usp_MaterialQcInspectionItem_HY_iud]
...
BEGIN
	...
	WHERE UserID = @pProcessUserID;
     ...
     /* IF (@CompanyCode = 'VVT' AND @pProcessUserID <> 'VVT_F5')
    BEGIN
        RAISERROR(N'Chỉ user VVT_F5 mới có quyền Thêm/Sửa/Xóa (IUD) dữ liệu này!', 16, 1)
        RETURN
    END
    */
        ...
        BEGIN TRY
            ...
            WHILE 1 = 1 BEGIN
                ...
                IF @IUD_FLAG = 'INSERT' BEGIN
                    ...
                    IF EXISTS (SELECT 1 FROM STB_MaterialQcInspectionItem_HY WHERE MaterialCode = @MaterialCode) BEGIN
