-- Fix HY SP bugs | Author: vanduc | Date: 2026-06-25
-- 1. usp_MaterialQcInspectionItem_ByMaterial_HY_get: xóa cột QcInspectionGroupDesc trùng
-- 2. usp_QcInspectionGroup_HY_popup: đổi bảng chung → _HY
USE SmartFactoryV2;
GO

ALTER PROCEDURE [dbo].[usp_MaterialQcInspectionItem_ByMaterial_HY_get]
...
ALTER PROCEDURE [dbo].[usp_QcInspectionGroup_HY_popup]
AS
BEGIN
    SET NOCOUNT ON;
    SELECT
