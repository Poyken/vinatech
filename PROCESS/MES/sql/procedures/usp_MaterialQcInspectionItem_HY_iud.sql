...
BEGIN
    ...
    */
    ...
    EXEC SmartFramework.dbo.usp_GetSerialRule 
			@pTableName = 'STB_MaterialQcInspectionItem',
    ...
    IF @IsAutoKey = 0 AND @IsLoopIUD = 0 BEGIN
	    ...
	    BEGIN TRY
			...
			-- Process ALL Table
            MERGE STB_MaterialQcInspectionItem AS TargetTable
			USING
				(
					SELECT
							CASE
        ...
        BEGIN TRY
            ...
            WHILE 1 = 1 BEGIN
                ...
                IF @IUD_FLAG = 'INSERT' BEGIN
                    ...
                    IF EXISTS (SELECT 1 FROM STB_MaterialQcInspectionItem WHERE MaterialCode = @MaterialCode) BEGIN
						RAISERROR('Duplicate Data : KeyField = %s', 16, 1, @MaterialCode)
					END

                    IF @IsAutoKey = 1 BEGIN
						EXEC SmartFramework.dbo.usp_DoCreateSerial 'STB_MaterialQcInspectionItem', @MaterialCode OUTPUT
                    END
				...
				END ELSE IF @IUD_FLAG = 'UPDATE' BEGIN
                    ...
                    UPDATE STB_MaterialQcInspectionItem
						SET
						    MaterialCode =   CASE
