...
var lastval="";
  ...
  port.on("data", function (chunk) {
    ...
    //   console.log("isEmpty(obj1.value) ::::: " + !obj1.value);
    //   console.log("isEmpty(obj2.value) ::::: " + !obj2.value);
    ...
    if(buffer && buffer.indexOf("ST,NT")>=0)
...
// function getSerialData(port, ID) {
//   var buffer = "";
//   var serialData = 0.0;
...
//   //         document.getElementById(ID).value = serialData;
//   //     }
//   // });
