...
WHERE ElectrodeLotNumber = ESI.ElectrodeLotNumber
  AND (SI.MaterialCode IN (
      ...
      'CREHCO85','CRYPK0-022','CRYPK0-011')) -- Updated 2026-08-18: Bỏ CREYO85-04 để tính đúng sản lượng TOP 1 cuộn mẹ, tránh x2
...
--end
    ...
    WHERE ElectrodeLotNumber = ESI.ElectrodeLotNumber
	  ...
	  'CRYPK0-022','CRYPK0-011') OR SI.MaterialCode IS NULL OR (SI.MaterialCode = 'CRECO85-03')) -- Updated 2026-08-18: Bỏ CREYO85-04
