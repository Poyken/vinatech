...
## 5. 🔌 ESM & ERP Interface Engine (Cầu nối và Đồng bộ dữ liệu)
...
### 5.1 Cơ chế Daemon Đồng bộ ERP (`usp_ERPInterface_daemon`)
...
*   **Đồng bộ danh mục sản phẩm (MaterialMaster):** Nhận lệnh `INSERT`/`UPDATE`/`DELETE` để đồng bộ trực tiếp sang bảng vật tư của ERP tại `erpsvr.erpdb.dbo.product`.
...
### 5.2 Danh sách bảng ESM và chức năng
...
### 5.4 Cấu hình ESM Collection (`ESM_ProdCollectionSetting`)
...
## 6. Ma Trận 25+ Biểu Mẫu Groupware & Điểm Tương Tác MES/ERP
...
## 10. ✍️ Cẩm Nang Lập & Vận Hành Chi Tiết Từng Loại Biểu Mẫu (Step-by-Step User Guide)
...
### 10.1 Nhóm Biểu Mẫu Mua Hàng & Nhập Kho Vật Tư (Purchase & Receiving)
...
### 10.2 Nhóm Biểu Mẫu Bán Hàng & Xuất Khẩu (Sales & Shipment)
...
### 10.3 Nhóm Biểu Mẫu Kế Hoạch & Sản Xuất (Production Planning & Execution)
...
### 10.4 Nhóm Biểu Mẫu Hành Chính, Nhân Sự & Tài Chính (HR, Admin & Finance)
...
### 10.5 Nhóm Biểu Mẫu Quản Lý Master Data (Master Data Management)
...
## 11. BOM Management Chi Tiết

### 11.1 Cấu trúc BOM trong DB
...
## 12. Danh Sách Kho Đầy Đủ (Verified 2026-06-10)
...
## 13. 🛠️ Cẩm Nang Hỗ Trợ Kỹ Thuật (Troubleshooting Guide)

### 13.1 Sự cố Đăng nhập MES
...
### 13.2 Sự cố Đồng bộ Kế hoạch/Sản lượng
...
### 13.3 Sự cố IQC (C220) & Nhập kho (Receiving)
