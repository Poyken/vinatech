...
$sql = "SELECT LotID, LotNo, MaterialWarehouseCode, MaterialLocationCode, PackingID, PackingIdParent FROM STB_MaterialLotInfo WHERE PackingID LIKE '%$search%' OR PackingIdParent LIKE '%$search%'"
