...
SELECT TOP 1 PackingID, ParentPackingID, LotNo, PackingQty FROM STB_DividePackaging WHERE PackingID = 'VVPQ132R71504' OR ParentPackingID = 'VVPQ132R71504' OR LotNo = 'VVPQ132R71504'
"
