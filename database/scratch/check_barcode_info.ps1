...
try {
    ...
    $cmd.CommandText = "SELECT MBI.ModelName, MBI.MBISizeH, MBI.MBISizeW, MBI.MBIExtText05 FROM STB_ModelBasicInfo MBI JOIN STB_SetInfo SI ON MBI.ModelCode = SI.MaterialCode WHERE SI.Barcode = 'WQM193R072798'"
