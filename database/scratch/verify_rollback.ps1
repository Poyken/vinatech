...
UNION ALL
SELECT 'Old Barcode Count (715xx)' as CheckType, NULL, CAST(COUNT(*) AS VARCHAR) FROM STB_SetInfo WHERE Barcode LIKE 'VVPQ132R715[0-1][0-9]'
UNION ALL
SELECT 'New Barcode Count (7156xx)' as CheckType, NULL, CAST(COUNT(*) AS VARCHAR) FROM STB_SetInfo WHERE Barcode LIKE 'VVPQ132R7156%'
"
