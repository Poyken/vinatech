...
$lotID = "ML20250606000100" # Based on the input in the screenshot but checking both
...
try {
    ...
    if ($dt.Rows.Count -eq 0) {
        Write-Host "Không tìm thấy lịch sử xuất kho cho các mã này."
    } else {
        Write-Host "Thông tin kho nguồn chính xác từ lịch sử:"
