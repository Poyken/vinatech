...
-- =========================================================================================
CREATE PROCEDURE [dbo].[usp_MaterialDocLotInfo_get]
...
BEGIN
	...
	SELECT
		 ...
		 case when  isnull(MDLI.LotAttr10,'')='' then  ''
		      when isnull(MDLI.PackDate, '') <> '' then MDLI.PackDate
			  ...
			  when @companycode='VVT' and @workcentercode IN ('VVT_F4') and MDLI.MaterialCode NOT IN ('DOW01-001', 'SILDOW-002', 'MDFLUX-002')  and ISDATE(MDLI.Lotattr10)=1  then CONVERT(VARCHAR(10), DATEADD(DAY, 0, CONVERT(VARCHAR(10), DATEADD(MM,  MM.MMExtInt01, MDLI.Lotattr10), 121)), 121)
			  --when @companycode='VVT' and @workcentercode NOT IN ('VVT_F4') and ISDATE(MDLI.Lotattr10)=1  then CONVERT(VARCHAR(10), DATEADD(DAY, 0, CONVERT(VARCHAR(10), DATEADD(day,  MM.MMExtInt01*30, MDLI.Lotattr10), 121)), 121)
