...
-- Modified:
--  2026-06-04: Strip 'F' prefix from @BarCode to support searching with or without the prefix.
--  exec  usp_Vietnam_GetMaterialFOQCInfo  '','','','','','','','2021-08-30','2021-09-15','e'
-- =============================================
ALTER PROCEDURE [dbo].[usp_Vietnam_GetMaterialFOQCInfo]
