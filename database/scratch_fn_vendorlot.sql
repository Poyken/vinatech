...
-- Description:	<Chuy?n d?i ngày tháng khi g?p code các nhà cung c?p khác nhau d?c lotno khác nhau>
...
declare @test varchar(200)=@materialcode +'--'+@vendorlot+'--'+@sourceCustomerCode
   ...
   when @materialcode in ('GBNN00-002') and @vendorlot='5292601221039' then '2026-01-22'
	...
	-- DinhManh update 2025-12-19			example:	3262511300387205|3262511300387206 cách d?c 30/11/2025
	...
	when @materialcode in (
						...
						,'GBAKAC-092'
							...
							--Ki?m tra xem NCC nào d? d?c lotno t?ng nhà cung c?p riêng
								...
								when @sourceCustomerCode in ('VV033')
									...
									--Ðây c?a nhà AOXING cung c?p nhôm
							...
							-- N?u không thu?c nhà cung c?p riêng thì s? t? phân tích chung
...
when @materialcode in (
	...
	when @materialcode IN (	'GBSN00-007',
							...
							'GBSN00-001') THEN '202'+ substring(@vendorlot,8,1) 
