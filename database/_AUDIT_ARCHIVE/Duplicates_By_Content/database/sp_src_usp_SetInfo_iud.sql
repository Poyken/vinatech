...
-- Group : 생산관리
-- Description:	
-- Modified: 2019.01.25 변수2건 추가
-- =============================================
CREATE PROCEDURE [dbo].[usp_SetInfo_iud]
    ...
    END ELSE BEGIN
        ...
        BEGIN TRY
            ...
            WHILE 1 = 1 BEGIN
                ...
                IF @IUD_FLAG = 'INSERT' BEGIN
					...
					IF ISNULL(@IsFixed,0) = 0 OR ISNULL(@IsCancel,0) = 1 BEGIN
							EXEC usp_RaiseLocalizedError @pProcessLanguage,'미확정 또는 취소된 계획은 Lot을 생성할수 업습니다'
					END
     --               IF EXISTS (SELECT 1 FROM STB_SetInfo WHERE ControlNo = @ControlNo) BEGIN
				...
				END ELSE IF @IUD_FLAG = 'UPDATE' BEGIN
					IF ISNULL(@CurrentIsLineInput,0) = 1 BEGIN
