...
-- [프로시저 실행문]        usp_Medium_Total_CEO '','','2019-10-01 00:00:00', '0820', ''

Create PROC [dbo].[usp_Medium_Total_CEO_Backup] 
...
BEGIN
	...
	FROM 
						(
							...
							GROUP BY 기준년월, 사이즈, LINECODE, CompanyCode
						) AA
						LEFT OUTER JOIN (
														SELECT 기준년월
																, 사이즈															
														...
														WHERE 1=1
														   ...
														   --AND 사이즈 = '0820' AND 기준년월 = '201910'
														GROUP BY 기준년월, 사이즈, 특이사항, LINECODE, CompanyCode
													) BB
		ON AA.기준년월 = BB.기준년월
	   AND AA.사이즈 = BB.사이즈 
	...
	WHERE 1=1
	  -- AND AA.기준년월 = @Month
	   ...
	   --AND  AA. 기준년월 = '201910'                -- test
	   --AND AA.사이즈  = '0820'                       -- test
