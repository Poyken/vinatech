...
Create PROCEDURE [dbo].[usp_MaterialWarehouseInOutHist_get_20200615]
...
BEGIN
   ...
   DECLARE @FromDate         VARCHAR(19) = CONVERT(VARCHAR(10), @pFromDate, 121) + ' 08:30:00'                                                            -- SELECT  CONVERT(VARCHAR(10), '2020-04-22', 121) + ' 08:30:00' 
	...
	IF @pProcessUserID in ( 'bgkoos', 'kilee', 'kilee2', 'yjjoo','koyeon','ecrkim')                      -- 2020.04.03 추가 (구보겸, 이강일, 주영진, 고연, 김은초롱 조회가능)
