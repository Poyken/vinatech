...
--            VNT : 540 / VVT : 660
-- 실행문 :  
--            usp_DayProdPlan_get_20220407 'kilee2' , '', NULL, 'VNT', 'VNT_F1' , '', '2022-04-07', '2022-04-07', '' , '', '' ,'' , ''
-- ================================================================================================
CREATE PROCEDURE [dbo].[usp_DayProdPlan_get_20220407]
...
BEGIN
	...
	SELECT
			...
			--'' AS LotID,
			--isnull(SI.SIExtReal03,mm.MaterialThickness) AS SIExtReal03  --modified by Mr.Tung on 2022-04-07 for Thickness auto fill in the B440
	FROM
