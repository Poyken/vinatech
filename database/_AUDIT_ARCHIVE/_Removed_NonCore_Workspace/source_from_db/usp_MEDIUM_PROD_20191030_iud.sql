...
-- Modified: 커맨트란 추가
-- =============================================
Create PROCEDURE [dbo].[usp_MEDIUM_PROD_20191030_iud]
...
BEGIN
  ...
  DECLARE @OldComment VARCHAR(200)
	    ...
	    BEGIN TRY
			...
			USING
				(
					SELECT
							...
							CASE   WHEN OldComment   IS NULL THEN Comment   ELSE OldComment		 END AS OldComment,
			...
			ON
				(
					...
					TargetTable.Comment = SourceTable.OldComment
				)
