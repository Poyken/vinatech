...
--  EXEC usp_GetProdRouteHistForRouteStockQty 'kilee', 'Korean','VNT', 'VNT_F1', 'ASSYLINE-05', '', ''
-- =============================================

CREATE PROCEDURE [dbo].[usp_GetProdRouteHistForRouteStockQty_20200602]
...
BEGIN
	...
	--SELECT @ControlNo = ControlNo 
	--  FROM STB_SetInfo
	-- WHERE Barcode IN ('VJKM012R710624','VJKL292R710609','VJKL292R710610')
  ...
  SELECT	POR.PONo,
	...
	WHERE 1=1
	   ...
	   AND PRH.ControlNo     IN ('20200329000052','20200329000053','20200401000048')
	GROUP BY POR.PONo,
			     PRH.LineCode,
				 LI.LineName,
				 SI.MaterialCode,
