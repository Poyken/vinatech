...
-- =============================================================================================
CREATE PROCEDURE [dbo].[usp_MaterialWarehouseInOutHist_iud_Backup]
...
---------------------------------------------------------	
	...
	--------------------------------------------------------------------------------------------------------------------------------------- 활성탄 추가부분 ------------------------------------
   --2020.05.12 추가사항 (활성탄 & 바인더 제품의 경우는 바코드 한번으로 일괄처리 - 구보겸요청)
	   IF @MaterialCode IN ('GAKCCA-002', 'GAKCCA-003','GATCCC-001') 	        
	...
	END
     ...
     -- 정상제품인 경우 (활성탄XX) 
	   IF @MaterialCode NOT IN ('GAKCCA-002', 'GAKCCA-003','GATCCC-001') 	   	   
