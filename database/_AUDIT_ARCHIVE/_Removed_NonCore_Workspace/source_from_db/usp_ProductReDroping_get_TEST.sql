...
--EXEC usp_ProductReDroping_get_TEST '','','','','','','','','2024-07-01','2024-07-13',''
 
CREATE PROCEDURE [dbo].[usp_ProductReDroping_get_TEST]
...
X as(
	...
	,
	 ...
	 SELECT  /* dbo.fnGetLocalTime(*/A.작업일자--,@pUtcOffset) AS 작업일자
	   ...
	   where (작업일자 between @FromDate  and @pToDate ) and   불량코드 ='V-29_XX1' or 불량코드 ='V-29_XX2' 
