...
-- Browsable : true
-- Group : 생산관리 > [B520]제품박스실적입력 > Grid3 BOX ID 정보
...
-- Exec usp_GetBoxIDForLotNo_VNT_20220321 'kilee','Korean','VJLS193R850606', ''
-- ==========================================================================
CREATE PROCEDURE [dbo].[usp_GetBoxIDForLotNo_VNT_20220321]                                  
...
-- // 한국본사 (VNT) 부분
	...
	SELECT
		...
		--,	'' AS LotQtyTwo
		   ...
		   , CONVERT(CHAR(10), GetDate(), 121) AS Today222
	FROM
