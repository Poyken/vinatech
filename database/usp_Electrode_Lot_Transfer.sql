...
-- Description:	L?y danh sách lot di?n c?c dã c?t chua b?n lên h? th?ng.
...
BEGIN
	...
	select ESR.*,MM.MaterialCode,MM.MaterialName
	  ...
	  and ss.LotMaterialCode is null -- l?y ra danh sách không thu?c b?ng stb_slittingStock_VVT
