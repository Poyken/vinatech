CREATE TABLE [dbo].[STB_CustomerComplaintsManagementInfo] (
    ...
    [CreateDateTime] DATE NOT NULL DEFAULT (getdate()),
    [CreateUserID] VARCHAR(20) NULL DEFAULT ,
    [ChangeDateTime] DATETIME NULL DEFAULT ,
    [ChangeUserID] VARCHAR(20) NULL DEFAULT ,
    [IsPerformance] BIT NOT NULL DEFAULT (CONVERT([bit],(0),0)),
    [DefectImage] VARBINARY(MAX) NULL DEFAULT ,
    [IsValidation1] BIT NULL DEFAULT ,
    [IsValidation2] BIT NULL DEFAULT ,
    [IsValidation3] BIT NULL DEFAULT ,
    [ValidationDocContent1] NVARCHAR(MAX) NULL DEFAULT ,
    [ValidationDocContent2] NVARCHAR(MAX) NULL DEFAULT ,
    [ValidationDocContent3] NVARCHAR(MAX) NULL DEFAULT ,
