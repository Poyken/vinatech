CREATE TABLE [dbo].[STB_NCR_Report] (
    ...
    [PPM] NUMERIC(30,5) NULL DEFAULT ,
    [InQty] INT NULL DEFAULT ,
    [BadLotQty] INT NULL DEFAULT ,
    [DefectiveRate] NUMERIC(30,5) NULL DEFAULT ,
    ...
    [IncongruityCheck] BIT NULL DEFAULT 
);
GO
