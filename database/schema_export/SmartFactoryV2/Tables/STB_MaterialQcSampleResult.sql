CREATE TABLE [dbo].[STB_MaterialQcSampleResult] (
    ...
    CONSTRAINT [PK_STB_MaterialQcSampleResult] PRIMARY KEY CLUSTERED ([MaterialQcNo], [MaterialQcDetailNo], [MaterialQcSampleNo])
);
GO
