-- Procedure: usp_CostGroupWorkerList_get_Dashboard
-- =============================================
...
-- 실행 : usp_CostGroupWorkerList_get_Dashboard '','','','VVT', ''
-- =============================================
CREATE PROCEDURE [dbo].[usp_CostGroupWorkerList_get_Dashboard]
...
BEGIN
	...
	SELECT CGWM.WorkerCode
	  ...
	  LEFT OUTER JOIN STB_CostGroupInfo CGI		ON CGWM.CostGroupCode = CGI.CostGroupCode
	  LEFT OUTER JOIN STB_ProdWorkerInfo PWI 		ON CGWM.WorkerCode = PWI.WorkerCode
	  LEFT OUTER JOIN STB_DayWorkGroup DWG	    ON PWI.WorkerCode = DWG.WorkerCode	   	   AND DWG.JobDate = @BaseDate
	  LEFT OUTER JOIN STB_CompanyInfo CI		ON CI.CompanyCode = CGI.CompanyCode
	  LEFT OUTER JOIN STB_WorkCenterInfo WCI		ON WCI.WorkCenterCode = CGI.WorkCenterCode
