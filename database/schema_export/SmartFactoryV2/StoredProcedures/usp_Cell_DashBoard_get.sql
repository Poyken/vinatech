-- Procedure: usp_Cell_DashBoard_get
-- ==================================================================
-- Author      : kilee
...
-- Description :  
-- Modified    : 
---[실행문]    EXEC usp_Cell_DashBoard_get 'ASSYLINE-09'
-- ==================================================================


CREATE PROC [dbo].[usp_Cell_DashBoard_get] 					
				--@pToMonth Datetime,
...
SELECT MPO.LineCode       AS 라인코드	    
	   ...
	   , MPO.월누적수량     AS 월누계수량   		
	   , CONVERT(NUMERIC(20,5), MPO.월누적수량) / CONVERT(NUMERIC(20,5), MPL.월간계획) * 100    AS 달성율
		--, MPO.*
