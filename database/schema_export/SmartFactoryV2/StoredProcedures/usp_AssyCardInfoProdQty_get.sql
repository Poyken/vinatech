-- Procedure: usp_AssyCardInfoProdQty_get
-- =============================================
...
-- [프로시저실행문]  	usp_AssyCardInfoProdQty_get  '','','VVOM173R010705', ''
-- ==============================================================================
...
END
	...
	select * from  STB_ProdRouteHist where ControlNo = '20260504000409'
GO
