-- Procedure: usp_Add_Fg_HN
-- =============================================
-- Author:		DinhManh
-- Create date: 2025-01-17
-- Description:	<Description,,>
-- =============================================
CREATE PROCEDURE [dbo].[usp_Add_Fg_HN]
	...
	--select * from STB_VN_FINISHGOODS
	  --STB_VN_FINISHGOODS
		 ...
		 EXEC SmartFramework.dbo.usp_GetSerialRule 
			@pTableName = 'STB_VN_FINISHGOODS_HN',
  ...
  IF @IsAutoKey = 0 AND @IsLoopIUD = 0 BEGIN
   ...
   BEGIN TRY
   	-- Process Insert Table
			 MERGE STB_VN_FINISHGOODS_HN AS TargetTable
			USING
				(
					SELECT
							CASE
...
SELECT
	   ...
	   WHILE 1 = 1 BEGIN
		  ...
		  IF @IUD_FLAG = 'INSERT' BEGIN
                    ...
                    IF EXISTS (SELECT 1 FROM STB_VN_FINISHGOODS_HN WHERE ID = @OldCompanyCode) BEGIN
			 ...
			 IF @IsAutoKey = 0 BEGIN
						...
						INSERT INTO STB_VN_FINISHGOODS_HN
						(
							SoPhieuNhapKho,
				            SoPhieuXuatKho,
							SoInVoice,
...
UPDATE STB_VN_FINISHGOODS_HN
			...
			Descrption =   CASE
					...
					WHERE
                        ...
                        DELETE FROM STB_VN_FINISHGOODS_HN
						WHERE
						    ID = ''
                    END
                END
