-- Procedure: usp_CurlingLine_Daily_Input_SUDONG
-- ==================================================================
-- Author      : kilee
...
CREATE PROC [dbo].[usp_CurlingLine_Daily_Input_SUDONG]  
	 @pRouteCode VARCHAR(20)
AS

---[실행문]    EXEC usp_CurlingLine_Daily_Input_SUDONG 'E-22'

--BEGIN
--   exec usp_CurlingLine_Daily_Input_SUDONG  'E-22'

--   exec usp_CurlingLine_Daily_Input_SUDONG 'E-23'

--   exec usp_CurlingLine_Daily_Input_SUDONG 'E-24'

--   exec usp_CurlingLine_Daily_Input_SUDONG 'E-25'

--   exec usp_CurlingLine_Daily_Input_SUDONG 'E-26'

--   exec usp_CurlingLine_Daily_Input_SUDONG 'E-27'

--   exec usp_CurlingLine_Daily_Input_SUDONG 'E-28'
...
-- [수동으로 실행시 -> 지우지말것]	
	DECLARE @FromDt             VARCHAR(19) =  '2019-08-26 08:30:00'            -- 전일                    
	DECLARE @ToDt                VARCHAR(19) =  '2019-08-27 08:30:00'            -- 금일
	DECLARE @ToDay              VARCHAR(02) =   '26'                                -- 전일자로 넣음
...
--DECLARE @ToDay VARCHAR(10) = '08'
   ...
   SET @sqlStr = '    UPDATE CURLING_PROD   SET DAY' + @ToDay + ' = ISNULL(B.[일일총수량], 0)    FROM CURLING_PROD A   INNER JOIN #TEMP_TABLE100 B  ON A.[라인코드] = B.[라인코드] AND RouteCode = ''' + @RouteCode + '''  AND 기준년월 = ''201909''       '
