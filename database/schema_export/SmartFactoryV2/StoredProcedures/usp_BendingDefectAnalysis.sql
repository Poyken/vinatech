-- Procedure: usp_BendingDefectAnalysis

-- =============================================
-- Author: Kangs(kilee@vina.co.kr)
-- Create date: 2022-02-22
-- Browsable : True
-- Group : 생산현황 > 일별 공정별 생산실적 > 절곡불량-   (5번째 화면)
-- Description:	 절곡 공정별 불량 파래토 

--    [usp_BendingDefectAnalysis]  'kilee2','Korean', '', '2022-02-01' ,'2022-02-20'
-- ======================================================================================================
CREATE PROCEDURE [dbo].[usp_BendingDefectAnalysis]
