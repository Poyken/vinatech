-- Procedure: ImportWarehouseFinshGood_RD_HN_uid
-- =============================================
-- Author:
-- Create date:
-- Description:	Nhập kho với tem nhỏ kho thành phẩm và với tem túi bóng Rnd
-- Test chay exec ImportWarehouseFinshGood_RD_HN_uid 'HaiTrieu','vi','pkpo1200278','P01','GH79623654','S01','','2025-06-27'
-- =============================================
CREATE PROCEDURE [dbo].[ImportWarehouseFinshGood_RD_HN_uid]
	-- Add the parameters for the stored procedure here
	@pProcessUserID VARCHAR(20),
    @pProcessLanguage VARCHAR(20),
	@pPackingID NVARCHAR(50), -- PackingID của tem nhỏ
	@pTYPEINPUT NVARCHAR(50), -- Kiểu nhập kho 
	@pPublicCode NVARCHAR(50), -- Mã kế toán
	@pSoPhieuNhapKho NVARCHAR(50), --
		...
		BEGIN
            ...
            -- Lấy từ bảng Tem Tách
               ...
               END
				...
				-- Tạo ID mới
				EXEC SmartFramework.dbo.usp_DoCreateSerial 'STB_VN_RND_FINISHGOODS_HN', @IDCODE OUTPUT;
				SET @IDCODE = 'FGVN_RD_HN' + @IDCODE;

				-- Insert
				INSERT INTO STB_VN_RND_FINISHGOODS_HN(
