-- Procedure: usp_GetScreenListForUserType_BK
...
-- =============================================
CREATE PROCEDURE [dbo].[usp_GetScreenListForUserType_BK]
		...
		SELECT
				...
				(
					SELECT
							...
							Item
					FROM
							dbo.fnSplitToTable(',',CTE.ParentNames)
					WHERE
							Item <> ''
					ORDER BY
							RowNo DESC
