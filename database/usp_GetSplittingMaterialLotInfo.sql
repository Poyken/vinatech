...
-- [???? ???] exec usp_GetSplittingMaterialLotInfo 'ML20250102000015' 
...
BEGIN
	...
	DECLARE @ActualExportQuantity NUMERIC(20,5)
		...
		select @ActualExportQuantity = ActualExportQuantity  from STB_MaterialWarehouseInOutHist where lotID=@pPackingID  and SourceMaterialWarehouseCode='ROH_HN_WH' and TargetMaterialWarehouseCode='SLITTING_HN_WH'  -- l?y ra t?ng s? lu?ng còn l?i dã chia
