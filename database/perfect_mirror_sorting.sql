-- =============================================
-- PERFECT EXCEL MIRROR DEPLOYMENT (FOR AUTO-FILL)
-- Date: 2026-04-24
-- Goal: Exact string match between DB/SP and Excel for 100% Auto-Fill success
-- =============================================
...
GO
-- Use bracketed parameter names to match Excel exactly for the mapper
CREATE PROC [dbo].[usp_VVT_SortingErrorData_ALCase_iud]
    ...
    @Vendor nvarchar(100) = NULL,
    @Factory nvarchar(100) = NULL,
    @Code_Marterial nvarchar(100) = NULL, -- The framework might use underscore for spaces in params
...
BEGIN
    ...
    END
    -- DELETE logic omitted for brevity as it's simple
END;
GO
