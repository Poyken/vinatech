...
--  usp_MaterialInventoryLotInfoTotal_PowerBI   
-- =============================================
CREATE PROCEDURE [dbo].[usp_MaterialInventoryLotInfoTotal_PowerBI]
...
BEGIN
	...
	WHERE 1=1
	  AND (MLI.MaterialWarehouseCode IN ('ROH_WH', 'ROH_VN_WH') )-- 원래없던 조건
