CREATE PROC [dbo].[usp_VN_showPaID] 
@PID NVARCHAR(50)
AS
BEGIN
...
--WHERE PackingID = @PID AND CompanyCode = 'VVT' AND MaterialLocationCode = 'PROD_VN_WH_01'
...
--ORDER BY LotNo DESC
 ...
 SELECT -- exec usp_VN_showPaID 'PKNK2100079'
       TOP(1)
		PrintTime AS ProductionDate,
		PackingID,
