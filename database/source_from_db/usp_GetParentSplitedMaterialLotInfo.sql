...
-- Description:	Get Parent Splited Lot for F746
-- =============================================

-- exec usp_GetParentSplitedMaterialLotInfo  '', '', 'VVT', 'VVT_F3', '', 'SLITTING_HN_WH', ''

CREATE PROCEDURE [dbo].[usp_GetParentSplitedMaterialLotInfo] 
...
BEGIN
	...
	IF (SUBSTRING(@LotID, 1, 2) = 'SL' OR SUBSTRING(@LotID, 1, 2) = 'SM')       -- Tìm kiếm theo LotNo con và LotNo đã gộp
		BEGIN
			WITH Lot AS
