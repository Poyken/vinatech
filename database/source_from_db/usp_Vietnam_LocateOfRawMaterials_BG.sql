...
-- Description:	Hiển thị Location kho Nguyên Vật liệu
-- ============================================= exec usp_Vietnam_LocateOfRawMaterials_BG
CREATE PROCEDURE [dbo].[usp_Vietnam_LocateOfRawMaterials_BG]
...
BEGIN 
  ...
  ,baseMatchMaterial as (
    ...
    lotattr10, createdatetime, createuserid, changedatetime, changeuserid ,56 as rollqty
      ...
      where 
	 materialwarehousecode in ('ROH_BG_WH','HOLDING_BG_WH') 
    ...
    lotattr10, createdatetime, createuserid, changedatetime, changeuserid ,56 as rollqty
      ...
      where 
	  materiallocationcode in ('ROH_BG_WH_01','HOLDING_BG_WH_01') 
	   --materiallocationcode like '%BG%'
