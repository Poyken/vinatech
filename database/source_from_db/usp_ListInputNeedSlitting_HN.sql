...
-- Description:	Lấy danh sách cần cắt khi kho nguyên vật liệu chuyển sang kho cắt
...
BEGIN
  ...
  SET NOCOUNT ON;
	...
	select @SumCurrentQty =SUM(CurrentQty),@sumTotalTem=COUNT(*) from STB_MaterialLotInfo where PackingIdParent=@LotID and lotid <> PackingID -- lấy ra tổng số lượng đã chia
