...
-- usp_MaterialInventoryLotInfo_PowerBI  'VVT', 'VvT_F1', 'ROH_VN_WH', 'ROH_VN_WH_01', '', '', 'ROH', '', '', 'ROH_VN_WH'

-- usp_MaterialInventoryLotInfo_PowerBI  'VNT', 'VNT_F1', 'ROH_WH', 'ROH_WH_01', '', '', 'ROH', '', '', 'ROH_WH'

-- usp_MaterialInventoryLotInfo_PowerBI  '', '', 'ROH_WH', 'ROH_WH_01', '', '', 'ROH', '', '', 'ROH_WH'
-- =============================================
CREATE PROCEDURE [dbo].[usp_MaterialInventoryLotInfo_PowerBI]
...
BEGIN
	...
	WHERE 1=1
		...
		AND	(MLI.MaterialWarehouseCode LIKE @MaterialWarehouseCode) 
		AND	MLI.MaterialLocationCode LIKE @MaterialLocationCode 
		AND	MLI.MaterialCode LIKE @MaterialCode 
		AND	MLI.MaterialStockAttribute LIKE @MaterialStockAttribute 		
...
--SELECT Prod* FROM STB_MaterialLotInfo WHERE CompanyCode = 'VVT' and PackingID = 'ML20210109000009'