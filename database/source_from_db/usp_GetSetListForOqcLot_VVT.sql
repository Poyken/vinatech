...
BEGIN
	...
	(
		...
		FROM
				...
				INNER JOIN STB_ProductionOrderRouting POR WITH(NOLOCK)		ON POR.PONo = SI.PONo AND POR.RouteCode IN ('E-22','V-22', 'MV-01','V-22_BG','VE01', 'V-33', 'V-33_BG','V-25') -- Mr.Triều add V-25 with Model JIANGHAI
