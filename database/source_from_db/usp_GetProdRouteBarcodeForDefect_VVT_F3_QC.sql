...
-- Description:	Thay thế cho màn hình C321 của nhà máy hà nam
-- =============================================
CREATE PROCEDURE usp_GetProdRouteBarcodeForDefect_VVT_F3_QC
...
BEGIN
	...
	WHERE
			...
			AND DI.DirectlyUnder IN ('PQC')   -- Mr.Duy add 2025-04-01
