...
-- usp_QCProdInspectionDefectModel_get '','','','2022-01-26','2022-02-25'
-- =============================================
CREATE PROCEDURE [dbo].[usp_QCProdInspectionDefectModel_get]
...
BEGIN
	...
	SELECT A.IDX
	  ...
	  FROM (
		   ...
		   ON 1=1
	 WHERE A.DefectQty <> 0
	 GROUP BY A.IDX, A.ModelName, A.DefectQty
