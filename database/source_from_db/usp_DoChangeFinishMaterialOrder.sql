...
-- Browsable : true
-- Group : 자재관리
-- Description:	자재발주전표 마감
-- Modified: 
-- =============================================
CREATE PROCEDURE [dbo].[usp_DoChangeFinishMaterialOrder]
        ...
        BEGIN TRY
            ...
            WHILE 1 = 1 BEGIN
                ...
                IF @IUD_FLAG = 'UPDATE' BEGIN
					...
					IF @OrderStatus <> 'FIX' BEGIN
						RAISERROR('Can not Change FINISH, Current OrderStatus : %s ',16,1,@OrderStatus)
					END
