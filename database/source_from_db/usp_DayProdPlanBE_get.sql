...
-- ================================================================================================
CREATE PROCEDURE usp_DayProdPlanBE_get
...
BEGIN
	...
	Declare @BasicRoutingCode VARCHAR(20) = CASE WHEN ISNULL(@pBasicRoutingCode, '') = '' THEN '%' ELSE @pBasicRoutingCode + '%' END
	...
	WHERE 1=1
			...
			AND MM.BasicRoutingCode LIKE @BasicRoutingCode
