...
-- =============================================
Create PROCEDURE [dbo].[usp_DoSlittingLot_TEST]
    ...
    END ELSE BEGIN
		...
		--raiserror(@MaterialSpec,16,1)
                ...
                IF @IUD_FLAG = 'INSERT' BEGIN
                    ...
                    IF EXISTS (SELECT 1 FROM STB_MaterialLotInfo_test WHERE MaterialLotNo = @MaterialLotNo) BEGIN
					...
					set @PackingID ='SL' + SUBSTRING(@NewLotID, 3, LEN(@NewLotID) - 2) 	
					 ...
					 --raiserror(@PackingIdParent,16,1)
				...
				END ELSE IF @IUD_FLAG = 'UPDATE' BEGIN
                    UPDATE STB_MaterialLotInfo_test
						SET
						    ...
						    PackingIdParent=@PackingIdParent
						   
						WHERE
						    MaterialLotNo = @OldMaterialLotNo
                END ELSE IF @IUD_FLAG = 'DELETE' BEGIN
                    DELETE FROM STB_MaterialLotInfo_test
						WHERE
						    MaterialLotNo = @OldMaterialLotNo
                END
            END
