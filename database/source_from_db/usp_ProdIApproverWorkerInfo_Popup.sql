...
-- TEST :  
--          EXEC usp_ProdIApproverWorkerInfo_Popup 'kilee','Korean','', '', '' ,NULL 
-- =============================================

CREATE PROCEDURE [dbo].[usp_ProdIApproverWorkerInfo_Popup]
	...
	IF @CostGroupString = '' 
		...
		BEGIN
			...
			WHERE 1=1
			   ...
			   AND PWI.EMPNO IN ('16030203', '16061303','12071101')       -- 채민수대리 고정
...
--  SELECT *	FROM STB_ProdWorkerInfo              WHERE WorkerName LIKE '김전식%'             -- 16030203
