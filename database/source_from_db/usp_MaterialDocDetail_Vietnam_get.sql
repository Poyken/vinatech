...
-- =============================================
-- EXEC [usp_MaterialDocDetail_get] '','','190607000006','','2019-01-01 00:00:00','2019-06-10 17:20:00',''

CREATE PROCEDURE [dbo].[usp_MaterialDocDetail_Vietnam_get]
...
BEGIN
   ...
   --    --2020.04.02 추가부분
			 Select 
			        @PickingAssignQty 		 = min(PickingAssignQty)
	...
	SELECT
			...
			MSAI.IsVendorLotUse,
			MSAI.IsUseBarcode,
			MDD.ManufacturerCode,		--Mr.Manh update 2026-04-15 ManufacturerCode,WeekCode,RevisionsVer for Bac Giang 2,
	...
	FROM
			...
			LEFT OUTER JOIN STB_CustomerInfo CI WITH(NOLOCK) ON MDD.ManufacturerCode = CI.CustomerCode		-- update 2026-04-15
	WHERE
...
-- select * from STB_MaterialDocDetail where line is not null
--select * from STB_

--SELECT MRMDExtText06 FROM STB_MaterialDocDetail
--ADD
--	MRMDExtText06 NVARCHAR(50) NULL