...
-- 프로시저실행 (2021-12-21)  : EXEC [usp_LotTrackingInfo_get] 'kilee','Korean', '', 'VNT', '2020-12-20', '2021-12-20', 'E-33', '', 'VJLT203R815708', '', ''
-- ===========================================================================================================

CREATE PROCEDURE [dbo].[usp_LotTrackingInfo_get_original]
