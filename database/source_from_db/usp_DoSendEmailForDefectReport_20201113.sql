...
-- Modified: 
-- 2020.10.15 베트남어 추가 (황명구 요청)
-- 2020.10.20 베트남 작업자명 누락원인 해결 (엄제식 요청)
-- 2020.10.21 작업자 및 발행자 추가 (이미정 요청)
-- 2020.11.11 전극공정검사 공정검사로 (최은화님 요청)

 -- 프로시저 실행 :  usp_DoSendEmailForDefectReport_20201113 '','','VN200924-02'
-- =============================================
CREATE PROCEDURE [dbo].[usp_DoSendEmailForDefectReport_20201113]
...
BEGIN
	Declare @DefectReportNo VARCHAR(20) = @pDefectReportNo
		   ...
		   -- 품질부문
		   ,@CcAddress VARCHAR(MAX) = 'nicekangil@naver.com;'
