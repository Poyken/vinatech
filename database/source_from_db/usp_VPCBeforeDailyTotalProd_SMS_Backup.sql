...
-- 프로시저 실행 :   usp_VPCBeforeDailyTotalProd_SMS_Backup  '',''
-- ===============================================================================================
CREATE PROCEDURE [dbo].[usp_VPCBeforeDailyTotalProd_SMS_Backup]
				...
				FROM (
								...
								FROM  (
																	...
																	SELECT TOP 100000   PRH.RouteCode
																		...
																		FROM STB_SetInfo SI WITH(NOLOCK) 
																				...
																				LEFT OUTER JOIN ( SELECT DRI2.ControlNo
																										...
																										AND PRH2.ProdDateTime BETWEEN '2022-03-03 08:30:00'  AND '2022-03-04 08:29:59'
																		...
																		WHERE 1=1
																			...
																			AND PRH.ProdDateTime BETWEEN '2022-03-03 08:30:00'  AND '2022-03-04 08:29:59'
														...
														UNION ALL
																...
																WHERE IPQ.CreateDateTime BETWEEN '2022-03-03 08:30:00'  AND '2022-03-04 08:29:59'
...
--			      + '[슬리브실적]' + '<br>' + @msg2 + '<br>' 
			...
			SET @LineMessage = 'VPC 전일 권취실적 공유드립니다.' + '<br>'
