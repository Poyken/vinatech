CREATE PROC [dbo].[usp_VN_RecoverUpdate] -- exec usp_VN_SearchDelete 'VVKN223R050511','trantuan','2020-10-11'
@IDCODES NVARCHAR(50),
@Person NVARCHAR(50),
@DateTime DATETIME
AS
BEGIN
	...
	[TypeAction]
		...
		@DateExport,@MethodActions,@MethodActions1,@Flag,@Person,@DateTime,'Up'
		)
END