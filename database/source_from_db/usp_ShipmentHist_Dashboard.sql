...
-- Modified :
-- =============================================
CREATE PROC [dbo].[usp_ShipmentHist_Dashboard]
    @pFromDate DATE
   ,@pToDate DATE
AS
BEGIN
	...
	SELECT SH.ShipmentHistNo AS OldShipmentHistNo
		  ...
		  ,SH.CustomerCode
		  ,CI2.LN_PARTNER AS CustomerName
		  ,SH.SalesTypeCode
	  ...
	  LEFT OUTER JOIN NEOE.NEOE.MA_PARTNER CI2
		ON CI2.CD_PARTNER = SH.CustomerCode
	   AND CI2.CD_COMPANY = '1000'
