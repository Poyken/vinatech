...
-- Modified:
-- =============================================
CREATE PROCEDURE [dbo].[usp_QcInspectionItem_iud]
...
BEGIN
  ...
  DECLARE @ChangeUserID VARCHAR(20)
    ...
    EXEC SmartFramework.dbo.usp_GetSerialRule 
			@pTableName = 'STB_QcInspectionItem',
    ...
    IF @IsAutoKey = 0 AND @IsLoopIUD = 0 BEGIN
	    ...
	    BEGIN TRY
            ...
            MERGE STB_QcInspectionItem AS TargetTable
			USING
				(
					SELECT
							CASE
        ...
        BEGIN TRY
            ...
            WHILE 1 = 1 BEGIN
                ...
                IF @IUD_FLAG = 'INSERT' BEGIN
                    ...
                    IF EXISTS (SELECT 1 FROM STB_QcInspectionItem WHERE QcInspectionItemCode = @QcInspectionItemCode) BEGIN
						RAISERROR('Duplicate Data : KeyField = %s', 16, 1, @QcInspectionItemCode)
					END

                    IF @IsAutoKey = 1 BEGIN
						EXEC SmartFramework.dbo.usp_DoCreateSerial 'STB_QcInspectionItem', @QcInspectionItemCode OUTPUT
                    END

                    INSERT INTO STB_QcInspectionItem
						(
						    QcInspectionItemCode,
						    QcInspectionGroupCode,
						    QcInspectionItemName,
                ...
                END ELSE IF @IUD_FLAG = 'DELETE' BEGIN
                    DELETE FROM STB_QcInspectionItem
						WHERE
