...
BEGIN
	SET NOCOUNT ON;
					...
					--Declare @StartYmd DATE = '2019-10-27'               -- 지우지말것 (원본백업)
					--Declare @EndYmd DATE = '2019-10-31'                -- 지우지말것 (원본백업)

					--Declare @StartYmd DATE = '2019-11-01'               -- 지우지말것 (원본백업)
					--Declare @EndYmd DATE = '2019-11-15'                -- 지우지말것 (원본백업)
					...
					-- [일일보고실적]                                                -- 주석처리부분
					--WHILE @StartYmd <= @EndYmd                          -- 위에 있어서 중복됨(주석처리부분임)
