...
-- Modified:
-- =============================================
CREATE PROCEDURE [dbo].[usp_DefectRepairInfoForDetail_iud]
    ...
    BEGIN TRY
        ...
        WHILE 1 = 1 BEGIN
			...
			END ELSE IF @IUD_FLAG = 'UPDATE' BEGIN
					...
					IF (@OldLineCode <> @FindLineCode) OR (@OldRouteCode <> @FindRouteCode) OR (@OldDefectQty <> @DefectQty) BEGIN
