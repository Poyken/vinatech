...
-- Description:	Get history input special SparePart
-- =============================================
CREATE PROCEDURE [dbo].[usp_VN_SpecialSparePartInput_get]
...
BEGIN
	...
	WHERE 1=1 
		...
		SSPI.WorkCenterCode LIKE @WorkCenterCode AND
		SSPIO.CreateDateTime BETWEEN @FromDate AND @ToDate	
END
