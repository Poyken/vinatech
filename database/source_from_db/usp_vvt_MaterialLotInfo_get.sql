...
,
 ...
 table1 as (
			...
			CASE WHEN @companycode='VVT' and @workcentercodeu IN ('VVT_F4') THEN CONVERT(VARCHAR(10), DATEADD(DAY, 1, CONVERT(VARCHAR(10), DATEADD(MM,  MM.MMExtInt01, MDLI.Lotattr10), 121)), 121)
	...
	FROM
		...
		OR (MaterialCode IN ('MPBT00-001', 'BEINS0-003', 'BEMC00-068', 'BEMC00-105', 'BEMC00-045', 'MDCLEAN-001', 'MDFLUX-001', 'MDIPA-001', 'BEMC00-043', 'BEMC00-044','MWLA00-037'
		,'ECVT30-358','MCIS00-001','MCMR00-001','MPBT00-001','PD-MMBM00-001','MWLA00-037','MWLA00-034','MCYH00-009','MWLA00-040','MMHA00-002','MMHA00-001') 
