...
-- 프로시저 실행 : usp_GetDefectRepairInfoByDefect_Dashboard 'kilee2','Korean','VVT','VVT_F1','','V-22','','','2019-01-26','2020-02-25'      --45건
--                         : usp_GetDefectRepairInfoByDefect_Dashboard 'kilee2','Korean','VNT','VNT_F1','','','','','2022-02-01','2022-02-10'               --1725건
-- ================================================================================================================================
Create PROCEDURE [dbo].[usp_GetDefectRepairInfoByDefect_Dashboard_TEST]
...
-- DECLARE @ProductGroupCode VARCHAR(20) = CASE WHEN ISNULL(@pProductGroupCode,'') = '' THEN '%' ELSE @pProductGroupCode END
	...
	FROM
			...
			LEFT OUTER JOIN STB_MachineMaster SMM ON SMM.MachineCode = PRH.MachineCode   --2022.02.16 추가 조인
	...
	WHERE 1=1
		...
		--	AND	DRI.FindJobdate BETWEEN '2021-03-26' AND  '2021-04-25' 
