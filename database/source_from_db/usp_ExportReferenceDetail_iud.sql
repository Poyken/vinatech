...
-- Modified:
-- =============================================
CREATE PROCEDURE [dbo].[usp_ExportReferenceDetail_iud]
    ...
    BEGIN TRY
        ...
        WHILE 1 = 1 BEGIN
            ...
            IF @IUD_FLAG = 'INSERT' BEGIN
                ...
                INSERT INTO stb_ExportReference_Detail
					(
						ExportReference_ID,
						LotNo,
						MaterialCode,
			...
			END ELSE IF @IUD_FLAG = 'UPDATE' BEGIN
                ...
                UPDATE stb_ExportReference_Detail
					SET
						LotNo =   CASE
            ...
            END ELSE IF @IUD_FLAG = 'DELETE' BEGIN
                DELETE FROM stb_ExportReference_Detail
					WHERE
						ID = @ID
            END
        END
