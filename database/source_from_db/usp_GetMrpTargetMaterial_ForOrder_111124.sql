...
-- Modified: usp_GetMrpTargetMaterial_ForOrder_111124'','','2018-01-01','2021-12-30','','1'
-- =============================================
CREATE PROCEDURE [dbo].[usp_GetMrpTargetMaterial_ForOrder_111124]
...
;with Ha as (
						...
						select DPP.PoNo,DPP.DayPlanNo,SUM( DPP.PlanQty) as soluongkehoachngay, PO.PlanQty as soluongPO,DPP.Plandate,DPP.linecode
						from  STB_DayProdPlan DPP
							left join STB_ProductionOrderInfo PO  WITH(NOLOCK) ON	DPP.PONo = PO.PONo
							where 
							--DPP.Pono='240825000006'
							-- and 
							DPP.Plandate between '2024-11-18' and  '2024-11-19'
							--and 
							--linecode = 'VVC-01' --and  
							--DPP.WorkCenterCode ='VVT_F2'
							
							Group by DPP.DayPlanNo,PO.PlanQty,DPP.PoNo,DPP.Plandate,DPP.linecode
			...
			left join STB_ProductionOrderBom POB
		 WITH(NOLOCK) ON	ha.PONo = POB.PONo
					   ...
					   And MWIOH.LotID NOT IN ( 
															   ...
															   WHERE MaterialLocationCode LIKE 'ROUTE_%'
															     --AND CreateDateTime BETWEEN @FromDate AND @ToDate
															      AND CreateDateTime BETWEEN '2024-11-18 00:00:00' AND '2024-11-19 23:59:59'
														    )
					   --and MWIOH.SourceMaterialWarehouseCode not in ('ELEC_VN_WH')
					   --And MWIOH.CreateDateTime BETWEEN @FromDate AND @ToDate		
					   And MWIOH.CreateDateTime  BETWEEN '2024-11-18 00:00:00' AND '2024-11-19 23:59:59'
