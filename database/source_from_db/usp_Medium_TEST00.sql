...
-- Browsable   : true
-- Group       :  생산현황 > [B603]입고생산현황 > Grid 첫번째
-- Description :  DB명 : [SmartFactoryV2]
-- Modified    : 입고생산현황 Summary 부분  
-- ==================================================================

-- [프로시저 실행문]        usp_Medium_TEST00 '','','2019-11-01 00:00:00', '1840', ''

CREATE PROC [dbo].[usp_Medium_TEST00]
...
BEGIN
	...
	FROM 
						...
						LEFT OUTER JOIN (
														...
														WHERE 1=1
														   ...
														   --AND 사이즈 = '0820' AND 기준년월 = '201910'
														GROUP BY 기준년월, 사이즈, 특이사항,  CompanyCode, LINECODE
	...
	WHERE 1=1	  
	   ...
	   AND AA.사이즈  like '1840'
	   
	   --AND AA.CompanyCode = 'VNT'
