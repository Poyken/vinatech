...
-- =============================================
CREATE PROCEDURE [dbo].[usp_Vietnam_ElectrodeDefectHist_get_BN_BG]
   @pProcessUserID VARCHAR(20), 
						...
						--@pFactory VARCHAR(20) = NULL  --update here
AS
...
lasttable as (
	...
	--left outer join STB_DefectInfo b on replace(a.DefectCode,'E-','V-') = b.DefectCode
		 ...
		 --  left outer join Electrode_BN_BG ebb with(nolock) on si.MaterialCode = ebb.MaterialCode
...
--and @pFactory IS NULL OR Factory LIKE '%' + @pFactory + '%'
