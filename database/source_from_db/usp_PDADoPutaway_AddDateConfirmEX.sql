...
-- Description:	cái này chỉ dùng để xác nhận đến ngày 20-3-2024 từ kho bắc ninh sang bg. khác usp_PDADoPutaway_AddDateConfirmEX_new
-- =============================================
CREATE PROCEDURE [dbo].[usp_PDADoPutaway_AddDateConfirmEX]
...
BEGIN
	...
	BEGIN
			...
			set MaterialLocationCode='ROH_BG_WH_01'
			where LotID = @pLotID
