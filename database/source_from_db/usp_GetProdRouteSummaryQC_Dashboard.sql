...
CREATE PROCEDURE [dbo].[usp_GetProdRouteSummaryQC_Dashboard]
...
BEGIN
	...
	IF OBJECT_ID('tempdb..#ProdRouteSummaryQC') IS NOT NULL DROP TABLE #ProdRouteSummaryQC
  ...
  IF ISNULL(@RouteCode, '') <> '' BEGIN
		SET @RouteCode = REPLACE(@RouteCode, 'E', 'V')
		...
		INSERT INTO #ProdRouteSummaryQC
		SELECT
				PRS.CompanyCode,
				PRS.WorkCenterCode,
				PRS.MaterialCode,
