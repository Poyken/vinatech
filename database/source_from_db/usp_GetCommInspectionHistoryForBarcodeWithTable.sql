...
-- EXEC [usp_GetCommInspectionHistoryForBarcode] 'kilee','Korean','ROUTE_QUALITY','VJJU032R750605','','','','',''
-- EXEC [usp_GetCommInspectionHistoryForBarcode] 'kilee','Korean','ROUTE_QUALITY','VVKJ193R010503','','','','',''

-- EXEC [usp_GetCommInspectionHistoryForBarcode] 'kilee','Korean','ROUTE_QUALITY','VJKJ263R033501','','','','',''

CREATE PROCEDURE [dbo].[usp_GetCommInspectionHistoryForBarcodeWithTable]
...
BEGIN
	...
	SELECT
		 ...
		 -- CIDI.CommInspRemark																																     AS CommInspRemark ,              -- 원본백업
		  ...
		  --SCH.CIDHExtText03                                                                                                                                                                                                   AS  NG_Check,                           -- 2020.01.31  검사결과 추가
