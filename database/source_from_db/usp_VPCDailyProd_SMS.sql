...
--               2022.03.24 임시테이블 삭제
--               2022.03.29 커링실적 - 설비기준으로 라인변경 (정준태)
--               2022.04.18 권취8실적추가 (김전식)
--               2022.04.20 커링합계부분 수정 

-- 프로시저 실행 :              usp_VPCDailyProd_SMS  '', ''
-- ================================================================================
CREATE PROCEDURE [dbo].[usp_VPCDailyProd_SMS]
 ...
 -- SELECT @msg = @msg + Z.LineName + ' (' + Convert(Varchar(20), PlanQty) + ' / ' + Convert(Varchar(20), ProdQty) + ' / ' + Convert(Varchar(20), ProdRate) + '% ' + ')<br>'
  ...
  FROM  (  
  		 ...
  		 --1. 권취누계추가   							
				...
				, Convert(Varchar(10), (GetDate()), 121)  As ProdDateTime
				, '권취' As RouteName
				, '[권취합계]' As LineName
     ...
     FROM  (  
						  ...
						  FROM  (
														SELECT Convert(CHAR(10), FIN.ProdDateTime, 121)  AS ProdDateTime 
																...
																, Case When MachineName = 'VPC#1 조립기' Then 'VPCLINE-01'
																		...
																		When MachineName = 'VPC#8 조립기' Then 'VPCLINE-08' Else 'VPCLINE-02' End As LineCode  -- 설비기준 라인변경 (2022.03.29)
																, FIN.LineName As LineName
																, Convert(BIGINT, Sum(FIN.ProdQty)) AS ProdQty
																, Convert(BIGINT, Sum(FIN.DefectQty)) AS DefectQty										
														FROM (
         ...
         --   Select  '[권취 실적]' + '<br>' + @msg + '<br>' 
			...
			SET @LineMessage = '금일 VPC 생산실적 공유드립니다.' + '<br>'
					    ...
					    + @msg2 
						--+  '※ 권취기 초음파 모듈 설치로 인하여 전체적으로 생산량 저하중입니다.' + '<br>'                           -- 전달사항 부분
						--+  '※ 금일부로 권취 8라인 실적 추가되었으며, 라인별 실적은 조립(커링)실적입니다.' + '<br>'                           -- 전달사항 부분
						--+  '※ 라인별 실적은 조립(커링)의 실적입니다.' + '<br>'      -- 전달사항 부분                    
						+  '※ 라인별 실적은 조립(커링)의 실적이며, 권취기 초음파 Setup으로 인하여 전체적으로 생산량 저하상태입니다.' + '<br>'                    -- 전달사항 부분		

              Select  @LineMessage    --주석부분

-- 1. 테스트용 (나만)	
      -- Exec usp_DoSendSMS '', '', '010-3222-6697,', @LineMessage , ''     

-- 2. 전직원 정규직 발송 (2022-05-02 변경 - 128명)   
Exec usp_DoSendSMS '', '', 
'010-4654-3727,010-3707-6551,010-5305-5305,010-9433-1324,010-9223-1754,010-8257-2990,010-9935-5313,010-7268-1995,010-4108-1002,010-2935-1748,010-4557-7870
,010-9437-2487,010-4404-3836,010-5886-5340,010-2019-1363,010-4412-1356,010-3629-6109,010-4465-1833,010-2834-4213,010-3676-1914,010-2000-3125,010-3584-8450
,010-6405-2254,010-7930-3727,010-3948-7605,010-4278-1425,010-9641-9994,010-3099-1130,010-5630-8986,010-5632-5754,010-5476-9346,010-9476-1663,010-9138-4083
,010-8536-6875,010-2417-6436,010-4580-7949,010-9476-1285,010-9547-0308,010-7577-5042,010-9088-1368,010-6395-9188,010-5038-2960,010-3519-9282
,010-8770-8608,010-3876-6391,010-5580-9695,010-8445-0786,010-3222-6697,010-7460-5995,010-8550-1291,010-2080-1826,010-2706-0652,010-3701-4951,010-7465-1204
,010-9200-8922,010-8760-1002,010-2079-4421,010-8075-1014,010-4277-0875,010-5106-4632,010-4660-4184,010-3511-5703,010-2769-9699,010-3659-9042,010-4191-6484
,010-9116-5235,010-2719-4222,010-4804-0584,010-3684-2983,010-8416-0408,010-8703-0570,010-4629-0763,010-9092-3044,010-5613-2567
,010-5270-4002,010-6613-2224,010-5548-0911,010-9092-4354,010-7466-3290,010-9436-0930,010-2043-4306,010-4214-5342,010-7612-7123,010-5613-0679
,010-8848-8231,010-7687-1601,010-6439-6622,010-2378-5681,010-2901-2070,010-9263-9714,010-9975-7717,010-9442-2061,010-2060-1714
,010-9206-4584,010-9212-1990,010-5630-0663,010-5192-2111,010-4378-8253,010-9174-5291,010-9458-2880,010-7585-8684,010-6415-9644,010-5317-2528,010-8694-2027
,010-2205-5828,010-2474-7006,010-9846-8885,010-2196-1049,010-4886-6444,010-4169-1257,010-2972-0351,010-2912-1830,010-6210-3421,010-3302-9512
,010-6797-4483,010-7645-9110,010-9981-4353,010-5582-9187,010-9241-2224,010-8468-3974,010-4134-7351,010-2204-2080,010-4232-2766
,010-6757-6702,010-3906-3248,010-7655-3650,010-2235-0225,010-8761-3449,010-4814-1963,010-8299-9625,010-4998-8628,010-2637-5199,010-8344-4181,010-9655-7682
,010-4190-1070,010-2629-2296,010-8469-8768'
, @LineMessage , ''         
