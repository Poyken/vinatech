...
-- Description:	Lấy danh sách lot điện cực đã cắt chưa bắn lên hệ thống. exec usp_List_Electrode_Lot_BG '','','2024-11-20','2024-11-28'
-- =============================================
...
WHERE ss.LotMaterialCode IS NULL
  ...
  /*
	...
	case 
	  ...
	  LEFT OUTER JOIN Stb_SlittingStock_VVT slt on esr.Barcode = slt.Barcode
	  where 
	 -- ss.LotMaterialCode is null -- lấy ra danh sách không thuộc bảng STB_RawMaterialInputHist nhập ở B597
	  NOT EXISTS 
