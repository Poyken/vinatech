...
-- ===========================================================================================================================
CREATE PROCEDURE [dbo].[usp_DoCreateCommInspDocHistory]
...
BEGIN
	...
	PRINT '@CommInspTypeCode ::::: ' + ISNULL(@CommInspTypeCode, '')
	PRINT '@CompanyCode ::::: ' + ISNULL(@CompanyCode, '')
	PRINT '@WorkCenterCode ::::: ' + ISNULL(@WorkCenterCode, '')
	PRINT '@LineCode ::::: ' + ISNULL(@LineCode, '')
	PRINT '@MoldNumber ::::: ' + ISNULL(@MoldNumber, '')
	PRINT '@ProductGroupCode ::::: ' + ISNULL(@ProductGroupCode, '')
	PRINT '@MaterialCode ::::: ' + ISNULL(@MaterialCode, '')
	PRINT '@CategoryName ::::: ' + ISNULL(@CategoryName, '')
	...
	IF NOT EXISTS (
						   ...
						   -- AND	 ((CII.RouteCode = '') OR (CII.RouteCode LIKE @RouteCode)) 
							  AND	 ((CII.MachineCode = '') OR (CII.MachineCode = @LineCode)) 
...
END
--	select * from STB_CommInspDocHistory where CommInspDocNo='20250312000204'
--	select * from STB_CommInspDocItem where CommInspDocNo='20250312000204'