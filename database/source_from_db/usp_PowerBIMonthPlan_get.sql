...
-- [프로시저 실행문]      usp_PowerBIMonthPlan_get 'kilee','Korean', '2020-03-01 00:00:00', '', 'VVT', ''
-- ==================================================================

CREATE PROC [dbo].[usp_PowerBIMonthPlan_get]
...
BEGIN
	...
	SELECT SL.LineName                               AS LineName
	        , IsNull(SUM(MP.월간계획), 0)			   AS 월간계획
	 FROM MEDIUM_PLAN MP
    ...
    Group By MP.LineCode, 공정코드, SL.LineName
