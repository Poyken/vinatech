...
-- Description:	Get Passed slitting for Ha Nam Factory
-- =============================================


-- usp_PassedSlittingHN_get '', '', '2025-01-01', '2025-02-28'

CREATE PROCEDURE [dbo].[usp_PassedSlittingHN_get]
...
BEGIN
	...
	WHERE 1=1
			...
			AND MLI.CheckTime BETWEEN @FromDate AND @ToDate -- thời gian mà QC kiểm tra và đánh giá Pass
