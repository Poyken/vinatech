...
--  프로시저실행 :   [usp_ProcessInspectionHistory2_get] 'kilee','Korean','VNT','VNT_F1','2020-04-28 00:00:00','2020-04-30  00:00:00','VVKM273R010504'
--                      usp_ProcessInspectionHistory_get 'kilee','Korean','VNT','VNT_F1','2020-04-28 00:00:00','2020-04-30  00:00:00',''
-- =============================================	
CREATE PROCEDURE [dbo].[usp_ProcessInspectionHistory2_get]
...
FROM (	 
		...
		WHERE 1=1	
		   AND CIDI.commInspItemCode in ('V_RQ_THICKP', 'V_RQ_THICKM')    -- 전극두께(+)  [RQ가 붙으면 공정검사 / RQ없으면 자주검사]		  
		) A		
WHERE 1=1	
