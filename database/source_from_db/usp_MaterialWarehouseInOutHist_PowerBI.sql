...
--  usp_MaterialWarehouseInOutHist_PowerBI  'VNT', '2020-01-01'
-- ==================================================================================

 CREATE PROCEDURE [dbo].[usp_MaterialWarehouseInOutHist_PowerBI]
...
BEGIN
   ...
   DECLARE	   @FromDate         VARCHAR(19) = CONVERT(VARCHAR(10), @pFromDate, 121) + ' 08:30:00'                                                            -- SELECT  CONVERT(VARCHAR(10), '2020-04-22', 121) + ' 08:30:00' 
	             ...
	             ,@ToDate VARCHAR(19) = CONVERT(VARCHAR(10), DATEADD(day, 1, GetDate()), 121) + ' 08:30:00'
