...
-- EXEC usp_LotTrackingInfo_Mornitorning_20200825_get '', '', '', ''
-- =============================================
CREATE PROCEDURE [dbo].[usp_LotTrackingInfo_Mornitorning_20200825_get]					
...
BEGIN
 ...
 --       WHERE 1=1		   
	...
	SELECT  XX.ComPanyCode							
	     ...
	     --     , Case When SUM(XX.CheckQty) = 0               Then 0 
					 --When SUM(XX.PlanQty) = 0 Then 0 
					 --  Else (SUM(XX.CheckQty) / SUM(XX.PlanQty)  * 100)  End AS '진행율(%)'
