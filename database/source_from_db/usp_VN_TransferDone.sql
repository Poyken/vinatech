CREATE PROC [dbo].[usp_VN_TransferDone] -- exec usp_VN_TransferDone '2024-03-01', '2024-03-31'
@pFrom DATE = NULL,
@pTo DATE = NULL
AS
BEGIN
		...
		WHERE PERSONSTATUSAPPROVER_BN = 1 AND PERSONSTATUSAPPROVER_BG = 1 AND SECURITYSTATUS_BG = 1 AND SECURITYSTATUS_BN = 1 AND CONVERT(DATE,DATEBY) BETWEEN @From AND @To
