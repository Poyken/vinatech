...
-- Description: Lấy ra dánh sách các lot spepart đã bị thay thế
-- =============================================
CREATE PROCEDURE [dbo].[usp_VN_InformationSpepaPartOutLine_get]
...
BEGIN
	...
	WHERE SPLU.WorkCenterCode=@WorkCenterCode AND SPLU.IsUsing=0
END
