...
--               2022.01.13 검사항목 추가 (최은화)

-- [Procedule실행문 ] usp_GetCommInspectionHistoryForBarcode 'kilee','Korean','ROUTE_QUALITY','VJLU302R710609','','','','',''
--                         usp_GetCommInspectionHistoryForBarcode @pProcessUserID='kilee',@pProcessLanguage='Korean',@pCommInspTypeCode='ROUTE_QUALITY',@pBarcode='VJJR023R036718',@pLineCode=default,@pRouteCode=default,@pMachineCode=default,@pMoldNumber=default,@pCategoryName=default
-- =======================================================================================================================================================================================================
CREATE PROCEDURE [dbo].[usp_GetCommInspectionHistoryForBarcode_20220113]
