...
-- Browsable : true
-- Group :
-- Description:	단가조회2 수정본
-- =============================================
-- usp_ItemUnitPrice_popup2

CREATE PROCEDURE [dbo].[usp_ItemUnitPrice_popup2] @pCustomerCode VARCHAR(20) = NULL, @pMaterialCode VARCHAR(20) = NULL
WITH RECOMPILE
AS
BEGIN
 ...
 --    ORDER BY 변경일자 DESC
         ...
         SELECT ISNULL(Unit, 0) as Unit FROM STB_Currency_Unit
