...
-- =============================================
CREATE PROCEDURE [dbo].[usp_Vietnam_PackingQtyWarehouse_A419_iud]
        ...
        BEGIN TRY
			...
			WHILE 1 = 1 BEGIN
				...
				IF @IUD_FLAG = 'INSERT' BEGIN
					...
					INSERT INTO STB_PackingQtyWarehouse
						(
							ModelCode,
							ModelName,
							Qty,
				...
				END ELSE IF @IUD_FLAG = 'UPDATE' BEGIN
					UPDATE STB_PackingQtyWarehouse
						SET
				...
				END ELSE IF @IUD_FLAG = 'DELETE' BEGIN
					DELETE FROM STB_PackingQtyWarehouse
						WHERE
							ID = @ID
