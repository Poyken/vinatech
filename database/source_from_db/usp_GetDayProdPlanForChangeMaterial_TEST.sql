...
-- =============================================
--exec usp_GetDayProdPlanForChangeMaterial_TEST '','','VVT','VVT_F1','','2024-01-01','2024-05-01','VVOM243R050508'
CREATE PROCEDURE [dbo].[usp_GetDayProdPlanForChangeMaterial_TEST]
	...
	@pBarcode VARCHAR(20) = 'VVOM243R050508'
AS
BEGIN
	SET NOCOUNT ON;
