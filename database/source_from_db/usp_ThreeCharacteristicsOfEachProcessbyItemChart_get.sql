...
-- Browsable : True
-- Group : 품질관리 > 제품검사 > [C545] 품목별공정별3대특성 데이터현황 Chart부분
-- Description:	
-- Modified:
-- 실행문 :  usp_ThreeCharacteristicsOfEachProcessbyItemChart_get '','','1025','','2021-02-01','2021-02-28','IQC_GPD_18'
--             usp_ThreeCharacteristicsOfEachProcessbyItemChart_get '','','','','2020-12-01','2020-12-31','IQC_GPD_19'
-- =============================================
CREATE PROCEDURE [dbo].[usp_ThreeCharacteristicsOfEachProcessbyItemChart_get]
