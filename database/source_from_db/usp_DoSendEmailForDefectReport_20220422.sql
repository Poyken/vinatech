...
-- =======================================================================================
Create PROCEDURE [dbo].[usp_DoSendEmailForDefectReport_20220422]
...
BEGIN
	...
	IF @ReceiveDeptName IN ('품질부문(베트남법인)', '생산부문(베트남법인)') BEGIN
		SET @ToAddress = @ToAddress + 'v.vietnamlocalstaff@vina.co.kr;'
	END

	
	--Begin by Mr.tung on 02-August-2021
	...
	if (@tmpDefectDivisionCode='09' and @tmpPublishDeptCode='9100')begin
		SET @ToAddress = 'shlee@vina.co.kr;shnoh@vina.co.kr;shlee2@vina.co.kr;jksung@vina.co.kr;nguyenquyen@vina.co.kr;caohung@vina.co.kr;tranhang@vina.co.kr;nguyenanh@vina.co.kr;leluan@vina.co.kr;nguyenchien@vina.co.kr;trantrung@vina.co.kr;nguyendiep@vina.co.kr'
		SET @CcAddress = ''
	end
	
	if ((@tmpDefectDivisionCode='09' and @tmpPublishDeptCode<>'9100') or (@tmpDefectDivisionCode<>'09' and @tmpPublishDeptCode='9100') ) begin
		SET @ToAddress = 'nguyenquyen@vina.co.kr'
		SET @CcAddress = 'nguyentung@vina.co.kr'
	end
	--end by Mr.tung on 02-August-2021
 ...
 --   SET @EmailBody = @EmailBody + '<body>'
    ...
    SET @EmailBody = @EmailBody + N'          <td height="20" valign="top" align="left">' + CASE WHEN @DefectDivisionName in ('공정검사', '전극공정검사') THEN '■' ELSE '□' END  + N'공정검사<br/>Kiểm tra công đoạn </b></td>'
    ...
    SET @EmailBody = @EmailBody + N'          <td valign="top" align="left">' + CASE WHEN @DefectDivisionName IN ('제품검사', '제품검사(베트남)' ) THEN '■' ELSE '□' END + N'제품검사<br/>Kiểm tra sản phẩm </b></td>'    
	...
	SET @EmailBody = @EmailBody + N'          <td valign="top" align="center" bgcolor="#ccccff"><b>발행자<br/>(nhà xuất bản)</b></td>'                              -- 추가부분 (발행자)
