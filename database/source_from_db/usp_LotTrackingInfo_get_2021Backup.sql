...
Create PROCEDURE [dbo].[usp_LotTrackingInfo_get_2021Backup]
...
if @CompanyCode='VNT' or @CompanyCode='*' begin
	...
	SELECT CASE WHEN PRH.ComPanyCode = 'VNT' THEN '전주본사'
		   ...
		   --, PRH.ProdQty 
			 ...
			 , CASE WHEN AFM.Barcode IS NOT NULL AND PRH.RouteCode IN ('E-25', 'V-25') THEN CONVERT(BIT, 1) ELSE CONVERT(BIT, 1) END   AS IsXRayImage
