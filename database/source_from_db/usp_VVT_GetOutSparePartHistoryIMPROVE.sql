...
-- Modified:             [usp_VVT_GetOutSparePartHistoryDetail] '','','VVT','VVT_F1','','2022-09-17','2022-09-19',''
-- =============================================
CREATE PROCEDURE [dbo].[usp_VVT_GetOutSparePartHistoryIMPROVE]
...
SELECT
	...
	WHERE
	        ...
	        (SPIOTC.IOType  in ('U') )  AND SPIOH.Attribute1 IS NULL AND 
