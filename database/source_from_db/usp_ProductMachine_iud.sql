...
-- Modified:
-- =============================================
CREATE PROCEDURE [dbo].[usp_ProductMachine_iud]
  ...
  DECLARE @ChangeUserID VARCHAR(20)
    ...
    IF @IsAutoKey = 0 AND @IsLoopIUD = 0 BEGIN
	    ...
	    BEGIN TRY
            ...
            MERGE STB_ProductMachine AS TargetTable
			USING
				(
					SELECT
							CASE
        ...
        BEGIN TRY
            ...
            WHILE 1 = 1 BEGIN
                ...
                IF @IUD_FLAG = 'INSERT' BEGIN
                    ...
                    IF EXISTS (SELECT 1 FROM STB_ProductMachine WHERE MachineCode = @MachineCode AND LineCode = @LineCode AND RouteCode = @RouteCode) BEGIN
						RAISERROR('Duplicate Data : KeyField = %s', 16, 1, @MachineCode)
					END

                    IF @IsAutoKey = 1 BEGIN
                        EXEC SmartFramework.dbo.usp_DoCreateSerial 'STB_ProductMachine',@MachineCode OUTPUT
                    END
