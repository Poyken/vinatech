...
--        exec usp_Vietnam_TappingBennding_get_TEST '','','2024-10-09','2024-12-30','tapping' 
--        exec usp_Vietnam_TappingBennding_get_TEST '','','2024-10-09','2025-01-30','bending' 

	--delete from STB_VN_BENDING_TAPPING where id=73487


-- =============================================

CREATE PROC [dbo].[usp_Vietnam_TappingBennding_get_TEST]
...
(
  ...
  for routecode in ([V-22],[V-23],[V-24],[V-25],[V-26],[V-27],[V-28])
	...
	select id, Dates,si.materialcode as ModelCode,codeproduction,LotNo,
	...
	group by id, dates,si.materialcode,codeproduction,lotno,machinename,pwi.workername,MarkingLetters,weight3.valweight
	--,total
	...
	--where lotno='VVLL303R033531'
		...
		SELECT
				...
				WHEN ModelCode = 'ECVT30-275' AND codeproduction = 'HY-CAP WEC3R0505QD' THEN Total_NG * 0.082515644
				WHEN ModelCode = 'ECVT30-276' THEN Total_NG * 0.068196416381011
		...
		FROM
				#t 
				where 
				--WorkerName= N'BUI THI NHU' and 
				lotno= 'VVPK132R740606'
