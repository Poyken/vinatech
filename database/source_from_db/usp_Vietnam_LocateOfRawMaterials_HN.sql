...
-- Description:	Hiển thị hệ thống locations cho nhà máy Hà Nam
--  exec usp_Vietnam_LocateOfRawMaterials_HN
-- =============================================
CREATE PROCEDURE [dbo].[usp_Vietnam_LocateOfRawMaterials_HN]
...
BEGIN
  ...
  ,baseMatchMaterial as (
    ...
    lotattr10, createdatetime, createuserid, changedatetime, changeuserid ,56 as rollqty
      ...
      where 
	 materialwarehousecode in ('ROH_HN_WH') 
    ...
    lotattr10, createdatetime, createuserid, changedatetime, changeuserid ,56 as rollqty
      ...
      where 
	  materiallocationcode in ('ROH_HN_WH_01') 
	   --materiallocationcode like '%BG%'
