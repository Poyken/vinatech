...
-- =============================================
CREATE PROCEDURE [dbo].[usp_MaterialQcInspectionItem_ByMaterial_get_BendingCutting]
...
BEGIN
	...
	*/
	...
	FROM
								  STB_MaterialQcInspectionItem_BendingCutting MIII WITH(NOLOCK)
...
--- SELECT * FROM STB_MaterialQcInspectionItem_BendingCutting WHERE MaterialCode = 'ECVT30-276'