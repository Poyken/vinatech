...
-- Make new named:    2020-03-07   usp_GetProdRouteSummary_vvt_get (nguyentung)

-- 실행 :   EXEC  [usp_GetProdRouteSummary_vvt_get] '','','','','ASSYLINE-12','E-24','ECVT30-115','2019-09-01','2019-09-18',''
--           EXEC  [usp_GetProdRouteSummary_vvt_get] '','','','','ASSYLINE-12',' ','ECVT30-076','2019-09-01','2019-09-18',''
-- =============================================
 -- 공정별 생산현황 전체조회 -> EXEC  usp_GetProdRouteSummary_vvt_get '','','','','ASSYLINE-07','','','2019-09-22','2019-09-23',''
--                                              usp_GetProdRouteSummary_vvt_get  '','','','','ASSYLINE-07','','','2020-01-26','2020-02-25',''

CREATE PROCEDURE [dbo].[usp_GetProdRouteSummary_vvt_get]
