...
-- =========================================================================
CREATE PROCEDURE [dbo].[usp_vvt_MaterialLotInfo_get_BG]
...
BEGIN
	...
	--end
					...
					--- cập nhật dữ liệu Ngay Thang SX của Vendor cho những Lót bị trống Ngay Thang SX
						...
						and MaterialLocationCode like '%BG_WH%'
	...
	(
	 ...
	 basedat as (
			...
			or MaterialWarehouseCode= case when @MaterialWarehouseCode not in ('ROH_BG_WH','ROUTE_BG_WH') then @MaterialWarehouseCode else '' end
)
