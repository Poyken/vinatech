...
-- Description:	적치 처리를 합니다. 
--                  이 프로시저에서 MaterialLotNo로 하여 불출처리가 창고이동 가능함.  (주의 함부로 처리하면 안됨)

-- 프로시저 실행 :   usp_PDADoPutaway '','','ROUTE_WH_00','20200630000124'
-- =============================================
CREATE PROCEDURE [dbo].[usp_PDADoPutaway]
...
BEGIN
	...
	--if(@RealLocationCode='HOLDING_VN_WH_01' or @RealLocationCode='HOLDING_BG_WH_01') 
	--	begin
	--				SELECT
	--				@LotID = MLI.LotID
	--		FROM
