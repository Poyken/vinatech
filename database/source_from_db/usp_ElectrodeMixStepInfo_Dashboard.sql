...
-- =============================================
CREATE PROCEDURE [dbo].[usp_ElectrodeMixStepInfo_Dashboard]
	@pFromDate DATE
   ,@pToDate DATE
AS
BEGIN
	...
	SELECT 	 ISNULL(EMSI.ElectrodeLotNumber, SI.Barcode) AS ElectrodeLotNumber
	 ...
	 LEFT OUTER JOIN STB_MaterialMaster MM2 ON MM2.MaterialCode = SI.MaterialCode
...
--select*from 
--STB_ElectrodeStep
--where ElectrodeStepCode = 'S1' or ElectrodeStepCode = 'S2';


--usp_ElectrodeMixStepInfo_Dashboard '2022-01-01','2022-01-31';