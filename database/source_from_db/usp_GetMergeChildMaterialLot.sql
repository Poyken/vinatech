...
-- [프로시저 실행문] exec usp_GetMaterialLotInfo '','','VVT','VVT_F1',' ','SM20250220000146'
  --usp_GetMergeChildMaterialLot '','','','SM20250220000146'
-- =============================================
CREATE PROCEDURE [dbo].[usp_GetMergeChildMaterialLot]
...
BEGIN
	...
	SELECT
			...
			--MLI.InitialQty,
			--MLI.CurrentQty,
			MLI.InitialQtyBefMerge  as InitialQty,
			MLI.CurrentQtyBefMerge as CurrentQty,
