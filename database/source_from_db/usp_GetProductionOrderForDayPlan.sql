...
--				계획수량 입력 컬럼의 날짜 포멧을 년월일에서 월일로 변경. 2019.09.27 주영진 차장님 요청 , By Jackaroe 롤백

-- 프로시저 실행 :  EXEC [usp_GetProductionOrderForDayPlan] '','','','','','' , 'ASSYLINE-01' ,'2019-09-01' ,'2019-09-10'
-- ===================================================================================================

CREATE PROCEDURE [dbo].[usp_GetProductionOrderForDayPlan]
