...
-- Exec [usp_Vietnam_SlittingStock_get] '', 'EA_PASS', '', 'SANXUAT', 'VVOO1020001E14-035', 'VVOO1020001E14-035' 

-- Exec [usp_Vietnam_SlittingStock_get] '', 'EA_PASS', '', '', 'VVPR2820001E06-002', 'VVPS023R036715' 
-- ============================================= 
CREATE PROCEDURE [dbo].[usp_Vietnam_SlittingStock_get] 
...
--select*from Stb_SlittingStock_VVT
