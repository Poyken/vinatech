...
-- Description:	
-- Modified:
-- 실행문 :  usp_ThreeCharacteristicsOfEachProcessbyItem_get '','','0820','','2020-01-01','2020-12-31','IQC_GPD_19'
--             usp_ThreeCharacteristicsOfEachProcessbyItem_get '','','','','2020-12-01','2020-12-31','IQC_GPD_19'
-- ===============================================================================================================
Create PROCEDURE [dbo].[usp_ThreeCharacteristicsOfEachProcessbyItem_get_20201208]
...
SELECT  VNT.Size    AS Size
          , VNT.Farad AS Farad
           , MAX(VNT.USL) AS USL
		   , MIN(VNT.LSL) AS LSL
		   , AVG(VNT.AVG) AS VNT_AVG
		   , AVG(VNT.CPK) AS VNT_CPK
          , AVG(VVT.AVG) AS VVT_AVG
          , AVG(VVT.CPK) AS VVT_CPK
FROM 
 (
