...
-- Description:	4M변경관리
-- Modified:
-- usp_FourMLotNoHist_iud '','','',''
-- =============================================
CREATE PROCEDURE [dbo].[usp_FourMLotNoHist_iud]
...
--ALTER TABLE STB_FourMLotNoHist ALTER COLUMN CreateDateTime DateTime NULL   -- MSSQL에서 컬럼변경
--ALTER TABLE STB_FourMLotNoHist ALTER COLUMN ChangeDateTime DateTime NULL   -- MSSQL에서 컬럼변경
