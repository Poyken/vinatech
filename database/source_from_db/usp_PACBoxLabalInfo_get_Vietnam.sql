...
-- =============================================
CREATE PROCEDURE [dbo].[usp_PACBoxLabalInfo_get_Vietnam]
	-- Add the parameters for the stored procedure here
			@pProcessUserID VARCHAR(20),
			@pProcessLanguage VARCHAR(20),
			@pLotNo VARCHAR(50) = NULL,
			@pTypeBoxCode VARCHAR(10) = NULL
AS
BEGIN
	...
	END
			...
			-- IN TEM THÙNG TRONG
	IF @pTypeBoxCode = 'OUTER'
		BEGIN
			EXEC usp_DoCreateSerial 'STB_PACBoxLabalPrintHist',@SN OUTPUT
			...
			SET @VN = 'IAC;6010A0981401;' + @rDC+ ';' + @LotNo + ';00500;' + @ReelID +';'

			SELECT
						MLI.MaterialCode,
						MM.MaterialName,
						MLI.PackingID,
						N'THÙNG NGOÀI' AS TypeBox,
						'6010A09801401' AS PN,
						@rDC AS DC,
						@LotNo AS Lot,
						500 AS Qty,
...
-- exec usp_PACBoxLabalInfo_get_Vietnam '' ,'' ,'VVPO213R060608'

-- exec usp_PACBoxLabalInfo_get_Vietnam '' ,'' ,'VVPP013R050771'
