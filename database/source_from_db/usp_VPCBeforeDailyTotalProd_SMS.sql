...
--               기존백업 프로시저명 :  usp_VPC_PerformanceTotal_SMS

-- 프로시저 실행 :                    usp_VPCBeforeDailyTotalProd_SMS  '',''
-- ==============================================================================

CREATE PROCEDURE [dbo].[usp_VPCBeforeDailyTotalProd_SMS]
...
--			      + '[슬리브실적]' + '<br>' + @msg2 + '<br>' 
			...
			SET @LineMessage = '전일 VPC 생산실적 공유드립니다.' + '<br>'
	                    + ' [기준일] : ' + ISNULL(@YesterDate,'') + '<br>'
						+ ' [기준시간] : ' + ISNULL(@StandardTime,'') + '<br>'					
						+  '[생산실적]' + ' ( ' + '목표수량' + ' | ' + '생산수량' + ' | ' + '완료율(%) )' + '<br>'
			            +	@msg + '<br>' 
						+ @msg2 
						+  '※ 권취기 초음파 Setup으로 인하여 전체적으로 생산량 저하상태입니다.' + '<br>'                    -- 전달사항 부분						
						--+  '※ 라인별 실적은 조립(커링)의 실적이며, 조립 4호기는 설비부동 중에 있습니다.' + '<br>'                           -- 전달사항 부분						
...
-- 2. 전직원 정규직 발송 128명 (2022-04-25 변경)   
Exec usp_DoSendSMS '', '', 
'010-4654-3727,010-3707-6551,010-5305-5305,010-9433-1324,010-9223-1754,010-8257-2990,010-9935-5313,010-7268-1995,010-4108-1002,010-2935-1748
...
,010-9138-4083,010-8536-6875,010-2417-6436,010-4580-7949,010-9476-1285,010-9547-0308,010-7577-5042,010-9088-1368,010-6395-9188,010-5038-2960
...
,010-7465-1204,010-9200-8922,010-8760-1002,010-2079-4421,010-8075-1014,010-4277-0875,010-5106-4632,010-4660-4184,010-3511-5703,010-2769-9699,010-3659-9042
,010-4191-6484,010-9116-5235,010-2719-4222,010-4804-0584,010-3684-2983,010-8416-0408,010-8703-0570,010-4629-0763,010-9092-3044,010-5613-2567
,010-5270-4002,010-6613-2224,010-5548-0911,010-9092-4354,010-7466-3290,010-9436-0930,010-2043-4306,010-4214-5342,010-7612-7123
,010-5613-0679,010-8848-8231,010-7687-1601,010-6439-6622,010-2378-5681,010-2901-2070,010-9263-9714,010-9975-7717,010-9442-2061,010-2060-1714
...
,010-4190-1070,010-2629-2296,010-8469-8768,010-5032-9753,010-2682-4245,010-4761-0851'
, @LineMessage , ''         
