...
-- [프로시저 실행문]   EXEC usp_DoAddCommInspMeasureHistForBarcode_TEST    'kilee','Korean','20200104000051','20200104001441','',     '1.11','2.22','3.33','4.44','5.55','6.66','7.77','8.88','9.99','10.10'           , '' , '0705201'  , ''                                   
 --  usp_DoAddCommInspMeasureHistForBarcode_TEST    'kilee','Korean','20211229000146 ','20220101003653','',     11,0,0,0,0,0,0,0,0,0           , '' , '18120501'  , ''      
-- =========================================================================================================================================================
CREATE PROCEDURE [dbo].[usp_DoAddCommInspMeasureHistForBarcode_TEST]
...
BEGIN
	...
	BEGIN
			IF @MaterialCode in ('LIVT38-018', 'LIVT38-020') AND @CommInspItemCode LIKE 'VPC%' AND @pProcessUserID = 'yjyu' BEGIN --# 2021.11.03
				...
				IF @OverSpecCnt > 0 BEGIN
					...
					-- SMS발송
					EXEC usp_DoSendSMS @pProcessUserID, pProcessLanguage, '010-2320-7233,010-5617-0713,010-6637-7780,010-3222-6697,010-4557-7870,010-9088-1368,010-9547-0308', 'VPC(0825) Lot 자주검사 중 스펙오버 수치가 입력되었습니다.({#1})', @Barcode
					RETURN
				END
			END
