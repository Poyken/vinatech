...
-- Description:	Hiển thị Location kho Nguyên Vật liệu cho nhà máy BG2
-- exec usp_Vietnam_LocateOfRawMaterials_BG2
-- =============================================
CREATE PROCEDURE [dbo].[usp_Vietnam_LocateOfRawMaterials_BG2] 
...
BEGIN
  ...
  ,baseMatchMaterial as (
    ...
    lotattr10, createdatetime, createuserid, changedatetime, changeuserid ,56 as rollqty
      ...
      where 
	 materialwarehousecode in ('MODULE_BG2_WH','HOLDING_BG_WH') 
	   --materiallocationcode like '%BG%'
    ...
    lotattr10, createdatetime, createuserid, changedatetime, changeuserid ,56 as rollqty
      ...
      where 
	  materiallocationcode in ('MODULE_BG2_WH_01','HOLDING_BG_WH_01') 
	   --materiallocationcode like '%BG%'
