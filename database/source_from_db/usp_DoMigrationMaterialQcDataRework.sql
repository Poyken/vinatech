CREATE PROC [dbo].[usp_DoMigrationMaterialQcDataRework]
AS
BEGIN
				...
				BEGIN
					...
					IF @CommInspItemCode = 'RQV_V' BEGIN
						SELECT @Value1 = SUM(CASE WHEN MQSR.MaterialQcSampleNo = 1 THEN TestValue ELSE 0 END)
							  ,@Value2 = SUM(CASE WHEN MQSR.MaterialQcSampleNo = 2 THEN TestValue ELSE 0 END)
							  ,@Value3 = SUM(CASE WHEN MQSR.MaterialQcSampleNo = 3 THEN TestValue ELSE 0 END)
							  ,@Value4 = SUM(CASE WHEN MQSR.MaterialQcSampleNo = 4 THEN TestValue ELSE 0 END)
							  ,@Value5 = SUM(CASE WHEN MQSR.MaterialQcSampleNo = 5 THEN TestValue ELSE 0 END)
