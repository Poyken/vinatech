		...
		Begin
			SELECT RMIH.RawMaterialInputHistNo as RawMaterialInputHistNo
					 ...
					 , RMBI.ProductGroupName_VVT                  -- 2020.02.14 추가 (베트남법인)
					  ...
					  MQI.ManufacturerCode, -- Mr.Trieu change for request Mrs.Ha BG2
					  MQI.Weekcode,	
					  MQI.RevisionsVer
					  ,tmp.RawBacodeList
			  FROM STB_RawMaterialInputHist RMIH with(nolock) 
						...
						left outer join STB_MaterialDocDetail MDD WITH(NOLOCK) ON MDD.MaterialIqcNo=MDI.materialdocno
