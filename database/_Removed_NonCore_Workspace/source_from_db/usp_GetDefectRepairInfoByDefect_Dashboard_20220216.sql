...
-- 프로시저 실행 usp_GetDefectRepairInfoByDefect_Dashboard '','','VVT','VVT_F1','','V-22','','','2019-01-26','2020-02-25'         --45건
--                    usp_GetDefectRepairInfoByDefect_Dashboard '','','','','','','','','2020-10-26','2020-11-25'
--   usp_GetDefectRepairInfoByDefect_Dashboard '','','','','','','','','2021-03-26','2021-04-25'
-- =============================================================================================
Create PROCEDURE [dbo].[usp_GetDefectRepairInfoByDefect_Dashboard_20220216]
