...
-- [usp_vvt_MaterialLotInfo_get_TEST2] '','','VVT', 'VVT_F1', 'HOLDING_VN_WH', '',  '',  '',  '',  '',  '',  '',  '',  '',  '',  '',  ''
-- [usp_vvt_MaterialLotInfo_get_TEST2] '','','VVT', 'VVT_F1', 'ROH_VN_WH', '',  '',  '',  '',  '',  '',  '',  '',  '',  '',  '',  ''
 
-- [usp_vvt_MaterialLotInfo_get_TEST2] '','','VNT', 'VNT_F1', 'ROH_WH', '',  'GAKA00-002',  '',  '',  '',  '',  '',  '',  '',  '',  '',  ''

-- [usp_vvt_MaterialLotInfo_get_TEST2] '','','VVT', '', 'ROH_BG_WH', '',  '',  '',  '',  '',  '',  '',  '',  '',  '',  ''

-- =========================================================================
CREATE PROCEDURE [dbo].[usp_vvt_MaterialLotInfo_get_TEST2]
	 ...
	 basedat as (
			...
			--			left outer join STB_CustomerInfo ci2  WITH(NOLOCK) on MDi.SourceCustomerCode = ci2.CustomerCode 
			 ...
			 (@pMaterialWarehouseCode='TOTAL_MATERIALS'    and MaterialLocationCode not like 'PROD%'    and  MaterialLocationCode  not like 'ROUTE%'
							 or MaterialLocationCode like @MaterialWarehouseCode+'%' and   a1.lotID = 'ML20230626000619'
					)
...
SELECT
	...
	where  
			...
			--and 
			--MLI.MaterialLotNo = '20230711000947' or MdLI.MaterialLotNo = '20230711000947' 
