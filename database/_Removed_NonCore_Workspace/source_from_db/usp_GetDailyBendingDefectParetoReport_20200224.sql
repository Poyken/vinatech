...
-- [usp_GetDailyBendingDefectParetoReport_20200224] '','','2022-02-01','2022-02-23', 'E-33'
-- ============================================================================================================================================

CREATE PROCEDURE [dbo].[usp_GetDailyBendingDefectParetoReport_20200224]
...
BEGIN
	...
	WHERE 1=1
	  ...
	  AND DRI.FindRouteCode  = @RouteCode
	   --and MM.MachineName Not in ('셀#1 커링&슬리브기','셀7 권취기')
