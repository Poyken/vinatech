...
-- EXEC usp_GetSetListForOqcLot_VVT @pProcessUserID='kilee',@pProcessLanguage='Korean',@pCompanyCode='VVT',@pWorkCenterCode='VVT_F1',@pLineCode='',@pBarCode = 'VVKK233R033571'       

-- EXEC [usp_GetSetListForOqcLot_VVT_20200224] @pProcessUserID='kilee',@pProcessLanguage='Korean',@pCompanyCode='VVT',@pWorkCenterCode='VVT_F1',@pLineCode='',@pBarCode = 'VVKK073R050515'       
                    
-- =============================================

CREATE PROCEDURE [dbo].[usp_GetSetListForOqcLot_VVT_20200224]
