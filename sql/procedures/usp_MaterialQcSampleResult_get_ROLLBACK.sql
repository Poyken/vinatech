...
-- =========================================================================
-- ROLLBACK SCRIPT FOR STAMPED DATA & STORED PROCEDURE
-- Run this script in SSMS to revert all changes made to the database.
-- =========================================================================

-- 1. Revert test data in STB_MaterialQcSampleResult
DELETE FROM STB_MaterialQcSampleResult 
WHERE MaterialQcNo = 'FVVQK113R825702' AND MaterialQcDetailNo = 2;

-- 2. Revert upload status in Stb_ESRValueMonitor
...
-- 3. Revert stored procedure to original version
