-- ==============================================================================
-- SCRIPT STORED PROCEDURE: usp_FinishGoodReportTK_HY
-- MÀN HÌNH: [FG02] Tổng hợp kho thành phẩm - TAB HƯNG YÊN RIÊNG BÊN CẠNH
-- PHIÊN BẢN TỐI ƯU SIÊU TỐC: 2026-08-18
-- TÁC GIẢ: Antigravity AI Agent
-- MÔ TẢ NGHIỆP VỤ CHUẨN:
--   Báo cáo kho thành phẩm riêng cho nhà máy Hưng Yên (STB_VN_FINISHGOODS_HY_NEW / FG01),
--   thêm cột [TotalAmount] (Tổng tiền Hưng Yên) và các cột Tuổi tồn kho Hưng Yên tính theo Mã Lot.
-- ==============================================================================
...
PRINT 'Stored Procedure [dbo].[usp_FinishGoodReportTK_HY] ultra-fast optimized successfully.'
