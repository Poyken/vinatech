...
--          cập nhật tính tuổi tồn kho theo Mã Lot.
-- ==============================================================================
...
BEGIN
    PRINT 'Restoring Stored Procedure [dbo].[usp_FinishGoodAllFactoryReport] from backup...'
END
GO
...
PRINT 'Restored [dbo].[usp_FinishGoodAllFactoryReport] from backup successfully.'
