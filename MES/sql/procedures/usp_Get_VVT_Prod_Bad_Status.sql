...
-- Browsable : true
-- Group : 조립불량현황
-- Modified: vanduc 2026-06-05: Restrict RouteCode to Cell Line only (exclude VE/VP) to fix B682 defect contamination
-- =============================================
...
ALTER PROCEDURE [dbo].[usp_Get_VVT_Prod_Bad_Status]
