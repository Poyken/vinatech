...
-- exec [usp_Vietnam_GetBoxIDForLotNo_VVT] '','','VVQQ293R025608','', ''
--update STB_MaterialLotInfo set Materialcode = 'LIVT38-018' where lotID = 'LIVT38-018OP1700019' ---
-- =============================================

CREATE PROCEDURE [dbo].[usp_Vietnam_GetBoxIDForLotNo_VVT]                                  
...
BEGIN
	...
	if(@LotNo in ('')) set @VJ2VV=0
	 ...
	 --raiserror ( @LotNo ,16,1)
	  ...
	  where UserID = @pProcessUserID
		...
		-- Cho Phép in chuyển từ VV thành VJ , điều kiện PARTNO làm chuẩn		-- DinhManh update 2025-06-18 remove VJ for Model VPC 1335 (LIVT38-009), following Mr.Diep BG 's request
	...
	if(@pProcessUserID in ('vvt_worker','vvtworker','huyen','mrchien','mrdiep','trantrung','msphuong','phuongnt','dangchinh','nguyennha','nguyentha','anhduy157','dinhmanh','vvtworker_bg','hoangxuan','worker_hn','ngocanh','HaiTrieu','vvtworker_hy')) set @lotweight =1;
	...
	-------------------------------------------
	--vanduc added by Mr.Tinh START 20260618
...
--raiserror(@PartNo,16,1)
	...
	SELECT
			...
			(case 
				...
				When @LotNo='VJPL053R025602' then 'VVQN053R025602'
				When @LotNo='VJPK063R025601' then 'VVQN063R025601'
				--end
				*/

				--vanduc edited by Mrs.Tran Lan 20260605 
				--start
				When @LotNo='VJPL103R025601' then 'VVQN103R025601'
				--end
				--vanduc edited by Mr.Tinh START 20260618
		...
		WHEN @LotNo='VVQM263R033520' then 'VVQM253R033546'
		WHEN @LotNo='VVQM263R033504' then 'VVQM253R033547'
		WHEN @LotNo='VVQM243R033532' then 'VVQM253R033548'
		WHEN @LotNo='VVQM233R033508' then 'VVQM253R033549'
		WHEN @LotNo='VVQM243R033507' then 'VVQM253R033550'
		WHEN @LotNo='VVQM263R033505' then 'VVQM253R033551'
		WHEN @LotNo='VVQM263R033510' then 'VVQM253R033552'
		WHEN @LotNo='VVQM233R033508' then 'VVQM253R033553'
		WHEN @LotNo='VVQM263R033503' then 'VVQM253R033554'
		WHEN @LotNo='VVQM263R033502' then 'VVQM253R033555'
		WHEN @LotNo='VVQM263R033510' then 'VVQM253R033556'
		WHEN @LotNo='VVQM273R033501' then 'VVQM253R033557'
		WHEN @LotNo='VVQM263R033510' then 'VVQM253R033558'
		WHEN @LotNo='VVQM253R033524' then 'VVQM253R033559'
		WHEN @LotNo='VVOJ103R070511' then 'VVQP133R070501'


		-- Thêm điều kiện chuyển đổi mã lot để tiến hành cấu hình mã lot 
		WHEN @LotNo='VVQN253R025605' then 'VVQN253R025645'
			  ...
			  CASE 
           WHEN @PartNo = 'VEL08203R8306G' THEN '3.8' --Mr.Trieu theo yêu cầu của chị nhu(Bắc Giang)
          ...
          END AS Voltage,
			...
			CASE
				-- UPDATE 2026-07-22 following Mrs.Hanh OQC AM, Lots in shipment for customer
			  WHEN @LotNo IN (
				  'VVQP143R033514',	
				  'VVQP143R033515',	
				  'VVQP143R033516',	
			   ...
			   WHEN @MaterialCod0='ECVT30-372' THEN 'WEC3R0335QG'
				...
				when @LotNo='VVQO023R010655' then 'WEC3R0106QA'
				when @PartNo='VEL13253R8157G-WC' then 'VEL13253R8157G-WC(70)'
			    when @LotNo='VVQP093R010648' then 'WEC3R0106QD'
				...
				WHEN @PartNo = 'WEC3R0256QG-D' AND @MaterialCod0 = 'ECVT30-379' THEN 'WEC3R0256QG'		-- Mr.Manh update 2026-05-06 following BG1 request
				when @LotNo in ('VVQL153R010651',
                                'VVQL153R010649',
                                'VVQL153R010648',
                                'VVQL153R010647',
                                'VVQL153R010646') then 'WEC3R0106QG'
			  WHEN @PartNo='WEC6R0255QD-OL-C68M42' then 'WEC6R0255QD-OL-C40M20'
			  when @LotNo in ('VVQP023R050602','VVQP023R050601') THEN 'WEC3R0506QG'
			  when @LotNo in ('VVQP073R060615') THEN 'VEC3R0606QG'
			  
			  when @LotNo in ('VVQQ263R050506',
                              'VVQQ273R050504',
                              'VVQQ273R050508',
                              'VVQQ273R050503',
                              'VVQQ233R050505',
                              ...
                              'VVQQ233R050504',
                              'VVQQ273R050501',
							  'VVQQ263R050504','VVQQ273R050510',
							  'VVQQ283R050510','VVQQ283R050509','VVQQ293R050503','VVQQ293R050504','VVQQ293R050505','VVQQ283R050501'
							  ) THEN 'WEC3R0505QD-NS'
					 -- Case các trường hợp đặc biệt thôi còn lại sẽ phải là mặc định cắt chuỗi theo 1 quy chuẩn nhất dịnh
					 -- Chỉ ácc trườn hợp đặc biệt là cần thay đổi thì mới cần cấu hình vào đây or có thể vào màn thay đổi Lot nếu cần
					 ELSE @PartNo		  
...
--select * from stb_setinfo where barcode='MVVQQ283R815701'
--select  * from STB_ChangePartNoAndLotNo where NewLotID='VVQQ293R025608'