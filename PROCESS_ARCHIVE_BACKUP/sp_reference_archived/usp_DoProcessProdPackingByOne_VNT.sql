...
BEGIN
 ...
 ------------- Ha add 10/08/2024
		...
		--Mr.Triều: Đây là giành riêng cho các con hàng VPC
...
-----------------------------------
	...
	WHILE @BoxCount >= @Count BEGIN
		    ...
		    -- Modified: Mr.Triều thêm cho nhà máy Hưng Yên trường hợp ở công đoạn cuối gộp box
			IF @RouteCode NOT IN ('E-28', 'V-28', 'V-28_BG','EM-03', 'M-06','VE10','V-28_HY')   --2022.02.09 추가 (MEA포장공정)
