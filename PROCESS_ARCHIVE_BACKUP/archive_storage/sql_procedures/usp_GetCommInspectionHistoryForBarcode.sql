		...
		MeasureDateTime DATETIME
			...
			--Mr Duy get CommInspTypeCode by Barcode
				...
				IF @userCompanyCode = 'VVT' BEGIN
					...
					else if(@getWorkCenterCode IN ('VVT_F2'))
						begin
					...
					else if(@getWorkCenterCode='VVT_F5')
						begin
							set @CommInspTypeCode='ROUTE_TEST2_HY'
						end
	...
	IF @userCompanyCode = 'VVT' OR @getCompanyCode = 'VVT' BEGIN
		SELECT
			...
			--	, SCH.CIDHExtInt03   AS ProcessSteps   --2021.10.20 추가사항
				...
				,'http://mes.hycap.co.kr:9952/manual/scm/SCM_ASSY_01.pdf' AS scm1
				,'http://mes.hycap.co.kr:9952/manual/scm/SCM_ASSY_02.pdf' AS scm2
				,'http://mes.hycap.co.kr:9952/manual/scm/SCM_ASSY_03.pdf' AS scm3
				,'http://mes.hycap.co.kr:9952/manual/scm/SCM_ASSY_04.pdf' AS scm4
				,'http://mes.hycap.co.kr:9952/manual/scm/SCM_ASSY_05.pdf' AS scm5
				,'http://mes.hycap.co.kr:9952/manual/scm/SCM_ASSY_06.pdf' AS scm6
				,'http://mes.hycap.co.kr:9952/manual/scm/SCM_ASSY_07.pdf' AS scm7
				,'http://mes.hycap.co.kr:9952/manual/sl7/SL7_ASSY_01.pdf' AS sl7_1
				,'http://mes.hycap.co.kr:9952/manual/sl7/SL7_HIPOT_02.pdf' AS sl7_2
				,'http://mes.hycap.co.kr:9952/manual/sl7/SL7_FCT_03.pdf' AS sl7_3
				,'http://mes.hycap.co.kr:9952/manual/sl7/SL7_PACKING_04.pdf' AS sl7_4
		FROM	STB_CommInspDocItem CIDI
