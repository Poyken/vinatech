...
-- [usp_ElectrodeSlittingResult_get] '','', 'VVQQ2720001E42'
-- =============================================
		...
		;with
			...
			,resultst as (
					...
					case when PartNo in ('2245') and SlittingCode ='YP' then '2245S,C'
						 ...
						 when MaterialCode = 'CREBK85L' and Partno = '0813' then '0813_Low'
						 when MaterialCode = 'CRFYN85L' and Partno = '1030' then '1030_Low' --Mr Bach request 2026-01-06
						 when MaterialCode = 'CRFYN85' and Partno = '1030' then '1030_VET' --Mr Bach request CREBK85L2026-01-06
